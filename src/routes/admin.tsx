        ...
        {(activeTab === "results" || activeTab === "controls") && (() => {
          ...
          return (
            <div className="space-y-6">
              ...
              {/* Seção de Exportação de Arquivos XML para Escritório de Contabilidade */}
              <div className="bg-gradient-to-r from-purple-950/60 via-zinc-900 to-zinc-950 border border-purple-500/30 rounded-3xl p-6 shadow-2xl space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h4 className="text-lg font-extrabold text-white mt-1 flex items-center gap-2">
                      <FileText className="size-5 text-purple-400" />
                      Exportação de Arquivos XML para Contabilidade
                    </h4>
                    <p className="text-xs text-zinc-300">
                      Geração de pacotes de arquivos XML padronizados (NFS-e ABRASF v2.04, Ledger de Solvência de Pontos e Fechamento Mensal Consolidado).
                    </p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
                  <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-4 space-y-3 flex flex-col justify-between">
                    <div>
                      <span className="text-[9px] font-bold uppercase tracking-wider text-purple-400">NFS-e ABRASF v2.04</span>
                      <h5 className="text-xs font-bold text-white mt-0.5">Take-Rate Marketplace (8%)</h5>
                      <p className="text-[10px] text-zinc-400 mt-1">XML de nota fiscal de intermediação de vendas do Shop.</p>
                    </div>
                    <a
                      href="/docs/xml_contabilidade/xml_nfse_take_rate_marketplace.xml"
                      download="xml_nfse_take_rate_marketplace.xml"
                      className="w-full py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-[11px] flex items-center justify-center gap-1.5 transition"
                    >
                      <Download className="size-3.5" />
                  ...
                  <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-4 space-y-3 flex flex-col justify-between">
                    <div>
                      <span className="text-[9px] font-bold uppercase tracking-wider text-lime-400">NFS-e ABRASF v2.04</span>
                      <h5 className="text-xs font-bold text-white mt-0.5">Serviços / Eventos de Parceiros</h5>
                      <p className="text-[10px] text-zinc-400 mt-1">XML de comissão por contratação por evento (sem mensalidade).</p>
                    </div>
                    <a
                      href="/docs/xml_contabilidade/xml_nfse_servicos_eventos.xml"
                      download="xml_nfse_servicos_eventos.xml"
                      className="w-full py-2 rounded-xl bg-lime-400 hover:bg-lime-300 text-zinc-950 font-bold text-[11px] flex items-center justify-center gap-1.5 transition"
                    >
                      <Download className="size-3.5" />
                      Baixar XML Serviços
                    </a>
                  ...
                  <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-4 space-y-3 flex flex-col justify-between">
                    <div>
                      <span className="text-[9px] font-bold uppercase tracking-wider text-cyan-400">Ledger Audit XML</span>
                      <h5 className="text-xs font-bold text-white mt-0.5">Solvência Atuarial nfs</h5>
                      <p className="text-[10px] text-zinc-400 mt-1">Extrato auditável do passivo de pontos (R$ 0,01/ponto).</p>
                    </div>
                    <a
                      href="/docs/xml_contabilidade/xml_ledger_pontos_solvencia.xml"
                      download="xml_ledger_pontos_solvencia.xml"
                      className="w-full py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-zinc-950 font-bold text-[11px] flex items-center justify-center gap-1.5 transition"
                    >
                      <Download className="size-3.5" />
                      Baixar XML Ledger
                    </a>
                  ...
                  <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-4 space-y-3 flex flex-col justify-between">
                    <div>
                      <span className="text-[9px] font-bold uppercase tracking-wider text-amber-400">Fechamento SPED</span>
                      <h5 className="text-xs font-bold text-white mt-0.5">Fechamento Mensal Consolidado</h5>
                      <p className="text-[10px] text-zinc-400 mt-1">Integração com Domínio, Contmatic, Alterdata e Totvs.</p>
                    </div>
                    <a
                      href="/docs/xml_contabilidade/xml_fechamento_mensal_contabil.xml"
                      download="xml_fechamento_mensal_contabil.xml"
                      className="w-full py-2 rounded-xl bg-amber-400 hover:bg-amber-300 text-zinc-950 font-bold text-[11px] flex items-center justify-center gap-1.5 transition"
                    >
                      <Download className="size-3.5" />
