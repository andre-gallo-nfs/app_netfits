 ...
 * Alinhado às diretrizes de integridade de dados e LGPD / Manifesto Netfits v2.0 & Business Plan.
 */
export const UserSignupSchema = z.object({
  ...
  declaredLoyaltyPrograms: z.array(z.string()).default([]),
  declaredPointsRange: z.string().default("0 - 10.000"),
