...
import { s as sharedSandboxStore, A as ADMIN_PILLARS, c as netfitsLogo, d as ALL_KR_MAP, b as authStore } from "./router-Bmlk0ggh.mjs";


import "../_libs/seroval.mjs";
import { w as ChartColumn, x as DollarSign, y as FileText, d as Sparkles, z as Cpu, A as Activity, g as Users, a as Award, I as Handshake, J as SlidersVertical, K as Coins, N as Rss, S as ShoppingBag, Z as Zap, i as Send, C as ChevronDown, O as TrendingUp, v as Lock, D as Download, V as RefreshCw, Y as CircleCheck, c as ShieldCheck, _ as Clock, R as RotateCcw, $ as MousePointerClick, a0 as Flame, a1 as Megaphone, o as Eye, a2 as Store, s as Tag, G as Gift, T as Truck, q as Star, a3 as ShoppingCart, a4 as UserPlus, a5 as Funnel, a6 as ShieldAlert, a7 as Save, a8 as UserCheck, a9 as Search, k as Check, X, aa as PenLine, ab as LogIn, ac as Trash2, ad as Archive, ae as Database, l as Share2, af as Phone, M as Mail, ag as KeyRound, h as ArrowRight, ah as ArrowUpRight, ai as ArrowDownRight, aj as ChevronLeft, ak as ChevronRight, E as ExternalLink, al as Key, b as Copy, am as Server, an as CodeXml, P as Play } from "../_libs/lucide-react.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl space-y-4 lg:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b border-zinc-800 pb-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm text-white", children: "Engajamento de Treinos & Atribuição do Shopping" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por Treino Validado (Smart Fit/GPS)", unit: "nfs / treino", value: operationalParams.nfsPerWorkout, onChange: (v) => setOperationalParams((p) => ({
                  ...p,
