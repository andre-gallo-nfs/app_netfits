...
import { e as InstitutionalWebHeader, t as trackSupportTicket, s as sharedSandboxStore } from "./router-OtdzUaKH.mjs";
import "../_libs/sonner.mjs";
import "./index.mjs";


import "../_libs/seroval.mjs";
import { M as Mail, n as MapPin, _ as CircleCheck, i as Send } from "../_libs/lucide-react.mjs";
...
function ContatoPage() {
  ...
  reactExports.useEffect(() => {
    if (cooldownSeconds > 0) {
      const timer = setTimeout(() => setCooldownSeconds((c) => c - 1), 1e3);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-3xl p-6 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs text-zinc-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-zinc-950 border border-zinc-800 space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-zinc-500 uppercase tracking-wider block", children: "E-mail Corporativo & Suporte" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white", children: "contato@netfits.com.br" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-zinc-950 border border-zinc-800 space-y-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-3xl p-6 space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-300 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: "Netfits Ltda." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-purple-300 text-[11px]", children: "CNPJ: 68.930.455/0001-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Alameda das Embaúbas, 365, Quadra 06 Lote 19 sala 01",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
