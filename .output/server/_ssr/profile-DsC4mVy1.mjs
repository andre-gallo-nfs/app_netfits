...
import { s as sharedSandboxStore, w as wallet } from "./router-XSMtvjXq.mjs";
import { as as ArrowLeft, U as User, a5 as LogIn, at as Camera, a7 as UserPlus, au as Sprout, b as Copy, h as Users, av as Calendar, ac as Phone, aa as Mail, M as MapPin, A as Activity, f as Check, aw as Plus, i as Heart, ao as Dumbbell, ax as Watch, V as Save, a as Award, d as Sparkles, L as Link2, ab as CreditCard, ay as CircleCheckBig, a3 as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background pb-28 font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 -mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-2xl ring-1 ring-black/5 p-5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-20 rounded-full bg-gradient-to-tr from-purple-700 to-lime-400 grid place-items-center text-white text-2xl font-black shadow-lg border-2 border-background", children: activeUser.fullName.substring(0, 2).toUpperCase() }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "px-4 pt-5 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { title: "Origem do cadastro e Convites", icon: isReferred ? UserPlus : Sprout, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 pt-2 border-t border-border flex items-center justify-between bg-muted/60 p-2.5 rounded-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-semibold uppercase block", children: "Seu código pessoal de convite:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-sm text-foreground", children: activeUser.referralCode })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => {
              navigator.clipboard.writeText(activeUser.referralCode);
              toast.success(`Código ${activeUser.referralCode} copiado!`);
            }, className: "bg-brand text-brand-foreground font-bold text-xs px-3 py-1.5 rounded-lg flex items-center gap-1 hover:opacity-90", children: [
