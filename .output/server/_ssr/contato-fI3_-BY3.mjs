...
import { t as trackSupportTicket, s as sharedSandboxStore$1 } from "./router-BZtdVS9k.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-BUbmCgk6.mjs";
import "../_libs/sonner.mjs";
import { a6 as Mail, k as MapPin, w as CircleCheck, e as Send } from "../_libs/lucide-react.mjs";
...
function ContatoPage() {
  ...
  const handleSubmit = (e) => {
    ...
    sharedSandboxStore$1.createContactTicket({
      name: formData.name,
