...
import { a0 as Lock, B as Building2, U as Users, ai as CircleQuestionMark, a6 as Mail, A as Activity, Z as Zap, S as ShoppingBag, a as Award, h as ShieldCheck } from "../_libs/lucide-react.mjs";
...
function InstitutionalHomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-white font-sans selection:bg-purple-500 selection:text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/80 px-6 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/home", className: "flex items-center gap-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-extrabold tracking-tight text-xl text-white", children: [
            "Netfits ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-lime-400 font-mono", children: "Ltda." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-6 text-xs font-semibold text-zinc-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/admin", className: "hover:text-purple-400 transition flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "size-3.5 text-purple-400" }),
            "Admin"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/parceiros", className: "hover:text-lime-400 transition flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "size-3.5 text-lime-400" }),
            "Parceiros"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/associado", className: "hover:text-amber-400 transition flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-3.5 text-amber-400" }),
            "Associados"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/faq", className: "hover:text-cyan-400 transition flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { className: "size-3.5 text-cyan-400" }),
            "FAQ"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/contato", className: "hover:text-indigo-400 transition flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-3.5 text-indigo-400" }),
            "Contato"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/download", className: "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold text-xs px-4 py-2.5 rounded-full shadow-lg shadow-purple-600/30 transition-all duration-200 flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "size-4" }),
          "Abrir App Netfits →"
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex items-center justify-around pt-3 border-t border-zinc-900 text-[11px] font-semibold text-zinc-400", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", className: "hover:text-white", children: "Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/parceiros", className: "hover:text-white", children: "Parceiros" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/associado", className: "hover:text-white", children: "Associados" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faq", className: "hover:text-white", children: "FAQ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contato", className: "hover:text-white", children: "Contato" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden pt-16 pb-20 px-6 border-b border-zinc-800/60 bg-gradient-to-b from-purple-950/40 via-zinc-950 to-zinc-950", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/30 rounded-full px-4 py-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: netfitsMark, alt: "", className: "w-4 h-4 object-contain" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-extrabold tracking-wider text-lime-400 uppercase", children: "Netfits Tecnologia Ltda. — Healthspan & Loyalty" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-3 pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/download", className: "w-full sm:w-auto px-8 py-4 rounded-2xl bg-white text-zinc-950 hover:bg-zinc-200 font-extrabold text-sm flex items-center justify-center gap-2 shadow-xl transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "size-4" }),
          "Entrar no Aplicativo & Feed"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/parceiros", className: "w-full sm:w-auto px-8 py-4 rounded-2xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-extrabold text-sm flex items-center justify-center gap-2 transition", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 px-6 max-w-6xl mx-auto space-y-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-3xl p-8 space-y-4 hover:border-purple-500/40 transition", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-zinc-400 leading-relaxed", children: "Leitura curada de artigos esportivos, postagens de treinos com GPS de wearables (Garmin, Strava) e acúmulo de pontos por engajamento (+5 nfs por ler, +10 nfs por compartilhar, +50 nfs por treino)." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-3xl p-8 space-y-4 hover:border-lime-500/40 transition", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white", children: "2. Netfits Shop com 2 nfs / R$" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-zinc-400 leading-relaxed", children: "Marketplace integrado com os maiores agregadores de e-commerce esportivo do Brasil. Ganhe 2,00 nfs por R$ 1,00 gasto no Shop com pagamento parcial/total com pontos e rastreabilidade total." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-3xl p-8 space-y-4 hover:border-amber-500/40 transition", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-zinc-400 leading-relaxed", children: "Assinatura por R$ 19,90/mês que dobra seus pontos em todas as compras no Shop (4,00 nfs por R$ 1,00) e concede cupons e acessos VIP a eventos e corridas de rua." })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 bg-gradient-to-r from-purple-950 via-zinc-900 to-zinc-950 border-y border-purple-500/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-center gap-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/parceiros", className: "px-8 py-4 rounded-2xl bg-lime-400 hover:bg-lime-300 text-zinc-950 font-extrabold text-sm flex items-center justify-center gap-2 shadow-xl transition", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-6 max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/associado", className: "px-6 py-3.5 rounded-2xl bg-amber-400 hover:bg-amber-300 text-zinc-950 font-extrabold text-xs flex items-center justify-center gap-2 shrink-0 transition", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-zinc-950 border-t border-zinc-800 pt-16 pb-12 px-6 text-xs text-zinc-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-white transition", children: "App Feed de Notícias" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", className: "hover:text-white transition", children: "Painel Executivo Admin" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Netfits Tecnologia Ltda." }),
...
export {
  InstitutionalHomePage as component
};
