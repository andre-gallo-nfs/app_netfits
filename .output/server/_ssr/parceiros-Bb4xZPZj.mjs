...
import { g as trackPartnerRegistration, s as sharedSandboxStore } from "./router-DDfi22jk.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-Cukb0pmb.mjs";
import "../_libs/sonner.mjs";
import { aq as Dumbbell, i as Users, ai as Apple, ar as HeartPulse, as as Flame, at as Stethoscope, j as ShieldCheck, d as Sparkles, a1 as CircleCheck, h as Check, al as Search, ah as CircleX, ac as CircleAlert, a3 as Mail, a2 as Phone, k as MapPin, au as Instagram, e as Send } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-white font-sans selection:bg-purple-500 selection:text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-gradient-to-b from-purple-950/70 via-zinc-950 to-zinc-950 border-b border-purple-500/20 py-8 md:py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 md:px-8 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm md:text-base text-zinc-300 max-w-2xl leading-relaxed", children: [
          "Cadastre sua academia, assessoria esportiva, clínica de recovery, consultório de nutrição ou medicina do esporte com ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "credenciamento 100% gratuito e zero taxa de adesão" }),
          "."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 border border-zinc-800 rounded-2xl p-4 space-y-1.5 hover:border-zinc-700 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-6 text-lime-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs md:text-sm font-bold text-white", children: "Zero Mensalidade" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] md:text-xs text-zinc-400 leading-snug", children: "Sem custos fixos. Remuneração baseada 100% em engajamento e serviços prestados." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 border border-zinc-800 rounded-2xl p-4 space-y-1.5 hover:border-zinc-700 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-6 text-purple-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs md:text-sm font-bold text-white", children: "Selo de Autenticidade" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] md:text-xs text-zinc-400 leading-snug", children: "Validação cadastral oficial com integração Receita Federal e Conselhos de Classe." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 border border-zinc-800 rounded-2xl p-4 space-y-1.5 hover:border-zinc-700 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-6 text-amber-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs md:text-sm font-bold text-white", children: "Fluxo de Novos Alunos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] md:text-xs text-zinc-400 leading-snug", children: "Divulgação direta para atletas engajados com cashback de pontos nfs no app." })
        ] })
      ] })
    ] }) }),
