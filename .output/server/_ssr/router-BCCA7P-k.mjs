...
const appCss = "/assets/styles-BFssOr-C.css";
...
class HomologationSandboxStore {
  ...
  rewardEngagement(action, postTitle) {
    ...
    const desc = action === "like" ? `Curtida no conteúdo: ${postTitle}` : action === "share" ? `Compartilhamento pós-visualização: ${postTitle}` : `Visualização completa: ${postTitle}`;
...
const emit$3 = () => listeners$3.forEach((l) => l());
const MULTIPLIERS = {
  atleta: 1,
  prime: 1.5,
  elite: 2
...
function useWallet() {
  return reactExports.useSyncExternalStore(subscribe$3, getSnapshot$3, getServerSnapshot$1);
}
...
const getSnapshot$2 = () => badgesList;
const badgesStore = {
  get: () => badgesList,
...
function useBadges() {
  return reactExports.useSyncExternalStore(subscribe$2, getSnapshot$2, getSnapshot$2);
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 bg-zinc-900/90 border-b border-zinc-800 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-bold text-zinc-200", children: [
          "Olá, ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-lime-400", children: activeUser.fullName.split(" ")[0] }),
          "! 👋"
        ] }),
...
const $$splitComponentImporter$d = () => import("./index-Bxlp7Hby.mjs");
...
const $$splitComponentImporter$c = () => import("./activities-Vn-8ACv7.mjs");
...
const $$splitComponentImporter$b = () => import("./admin-BpkWJAWH.mjs");
...
const $$splitComponentImporter$a = () => import("./associado-BAMKplap.mjs");
...
const $$splitComponentImporter$9 = () => import("./auth-s7aHFZIB.mjs");
...
const $$splitComponentImporter$8 = () => import("./contato-C5D0hpMa.mjs");
...
const $$splitComponentImporter$7 = () => import("./download-Bpr0tqkp.mjs");
...
const $$splitComponentImporter$6 = () => import("./faq-knUKLOA6.mjs");
...
const $$splitComponentImporter$5 = () => import("./home-6NgDtN4f.mjs");
...
const $$splitComponentImporter$4 = () => import("./levels-vwteb44g.mjs");
...
const $$splitComponentImporter$3 = () => import("./market-SDDKSX2U.mjs");
...
const $$splitComponentImporter$2 = () => import("./parceiros-D9mwRjUG.mjs");
...
const $$splitComponentImporter$1 = () => import("./profile-VFMuKrJx.mjs");
...
const $$splitComponentImporter = () => import("./wallet-BjMMUeGE.mjs");
...
export {
  ADMIN_PILLARS as A,
  useOperationalParams as a,
  authStore as b,
  ALL_KR_MAP as c,
  useAuth as d,
  nativeBridge as e,
  detectIdentifierType as f,
  netfitsDarkLogo as g,
  trackAppDownload as h,
  useBadges as i,
  badgesStore as j,
  trackPartnerRegistration as k,
  launchMkplaceShop as l,
  netfitsLogo as n,
