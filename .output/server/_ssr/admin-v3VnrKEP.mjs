...
import { s as sharedSandboxStore$1, u as useOperationalParams, A as ADMIN_PILLARS, n as netfitsLogo, a as ALL_KR_MAP, o as operationalParamsStore } from "./router-BZtdVS9k.mjs";
import { a as authStore } from "./auth-store-VQBUniEq.mjs";
...
function AdminAuthGuard({ children, onUnlocked, onLock }) {
  ...
  reactExports.useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedAuth === "true" || currentUser?.email === "andre.gallo@netfits.com.br" || currentUser?.email === "andre@netfits.com.br") {
        setIsUnlocked(true);
  ...
  const handlePasswordLogin = (e) => {
    ...
    if ((cleanEmail === "andre.gallo@netfits.com.br" || cleanEmail === "andre@netfits.com.br" || cleanEmail === "admin@netfits.com.br" || cleanEmail === "diretoria@netfits.com.br") && (cleanPass === "Netfits#2026" || cleanPass === "Admin@2026" || cleanPass === "202626")) {
      setIsUnlocked(true);
      if (typeof window !== "undefined") {
        sessionStorage.setItem(SESSION_STORAGE_KEY, "true");
        sessionStorage.setItem("netfits_admin_authenticated", "true");
