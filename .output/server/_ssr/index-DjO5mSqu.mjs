...
import { f as feedItems, u as useBadges, w as wallet, s as sharedSandboxStore } from "./router-I6FzPhOB.mjs";
import { P as ProductDetailSheet } from "./ProductDetailSheet-n8wU4fds.mjs";
import { n as netfitsMark } from "./netfits-mark-DN6CUhW7.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { u as useOperationalParams } from "./operational-params-store-CIc3l6mH.mjs";
import { B as Building2, d as Sparkles, c as ArrowRight, f as Check, P as Play, g as Share2, X, G as Gift, h as Users, b as Copy, A as Activity, i as Heart, j as ShieldCheck, L as Link2, M as MapPin, k as Eye, l as Bookmark, S as ShoppingBag } from "../_libs/lucide-react.mjs";
...
function InviteFriendsCard() {
  ...
  const handleChannel = (key) => {
    ...
    const url = key === "wpp" ? `https://wa.me/?text=${encoded}` : key === "tg" ? `https://t.me/share/url?url=${encodeURIComponent(INVITE_URL)}&text=${encoded}` : key === "x" ? `https://twitter.com/intent/tweet?text=${encoded}` : key === "fb" ? `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(INVITE_URL)}` : key === "mail" ? `mailto:?subject=${encodeURIComponent("Vem pra netfits")}&body=${encoded}` : key === "msg" ? `sms:?&body=${encoded}` : null;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "relative overflow-hidden rounded-[20px] bg-foreground text-background p-6 ring-1 ring-zinc-950/10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[22px] font-semibold leading-tight text-balance mb-2", children: [
          "Kite, chame sua tribo e ganhe nfs ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-background/10 ring-1 ring-background/15 rounded-full pl-4 pr-1 py-1 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-bold tracking-wider truncate", children: INVITE_CODE }),
...
function FeedPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BadgesBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-4 mb-3 p-3.5 bg-purple-600/10 border border-purple-600/30 rounded-2xl flex items-center justify-between shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-xl bg-purple-600 text-white grid place-items-center font-black text-xs shadow-sm shrink-0", children: "nfs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "Recompensas por Engajamento Real" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-medium", children: "Visualização Completa (+5 nfs) · Compartilhamento Pós-Visualização (+10 nfs)" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-4 p-3.5 bg-gradient-to-r from-zinc-900 via-purple-950 to-zinc-900 border border-purple-500/30 rounded-2xl flex items-center justify-between shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-xl bg-lime-400 text-black grid place-items-center font-black text-xs shadow-sm shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "size-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-white", children: "É dono de Academia, Assessoria ou Clínica?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-300", children: "Cadastre seu estabelecimento e ofereça benefícios" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/parceiros", className: "bg-lime-400 text-black hover:bg-lime-300 font-extrabold text-[10px] uppercase tracking-wider px-3 py-1.5 rounded-full shrink-0 shadow-sm transition", children: "Cadastrar →" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 pt-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-8 text-center text-xs text-muted-foreground", children: "Carregando mais conteúdo…" })
    ] })
  ] });
}
function WearableSurveyHero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-foreground rounded-[22px] p-6 text-background relative overflow-hidden ring-1 ring-zinc-950/10 shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: netfitsMark, alt: "", className: "absolute top-4 right-4 w-10 h-10 object-contain rounded-lg bg-background/10 p-1 opacity-80" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-600/30 text-purple-300 border border-purple-400/30 text-[10px] font-bold uppercase tracking-widest mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-3 text-lime-400" }),
        "Pesquisa de Intenção"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold leading-tight text-balance mb-2", children: "Você gostaria de conectar seu relógio ou app de treino à Netfits?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-300 max-w-[38ch] leading-relaxed mb-4", children: "Ajude-nos a definir a próxima grande funcionalidade! Qual dispositivo você mais usa para registrar seus treinos?" }),
      !voted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: devices.map((dev) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setSelectedDevice(dev.id), className: `p-2.5 rounded-xl border text-left text-xs font-semibold flex items-center gap-2 transition-all ${isSelected ? "bg-purple-600 text-white border-lime-400 ring-2 ring-lime-400/40" : "bg-background/10 border-white/10 text-zinc-300 hover:bg-background/20"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: dev.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: dev.name })
          ] }, dev.id);
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleVote, className: "w-full mt-2 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white font-bold text-xs py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-purple-900/40 active:scale-98 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-4 text-lime-400" }),
          "Votar & Quero Conectar (+10 nfs)",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "size-4" })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-950/60 border border-lime-400/40 rounded-xl p-4 text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-full bg-lime-400 text-zinc-950 grid place-items-center mx-auto shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "size-5 font-black" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-white", children: [
          "Voto Registrado: ",
          selectedDevice
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-300 leading-relaxed", children: [
          "Muito obrigado! Sua resposta foi enviada com sucesso e ajudará nossa equipe a priorizar a integração com ",
          selectedDevice,
          "."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[10px] font-extrabold text-lime-400 pt-1", children: "+10 nfs creditados na sua carteira!" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-[-10%] bottom-[-20%] w-64 h-64 bg-purple-600/20 blur-3xl rounded-full pointer-events-none" })
  ] }) });
}
function BadgesBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/levels", className: "block bg-purple-900/10 border border-purple-600/30 hover:bg-purple-900/20 transition-all rounded-2xl p-4 ring-1 ring-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-2xl bg-purple-600 text-white grid place-items-center font-bold text-lg shrink-0 shadow-md", children: "🏅" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground flex items-center gap-1.5", children: "Galeria de Badges & Selos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-extrabold font-mono text-purple-600", children: [
          unlockedCount,
          "/",
          totalCount,
          " Selos"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: "Execute tarefas de engajamento e desbloqueie bônus em nfs." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-purple-950/20 rounded-full overflow-hidden mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-gradient-to-r from-purple-600 to-lime-400 rounded-full", style: {
        width: `${progressPct}%`
      } }) })
    ] })
  ] }) }) });
...
function FeedCard({
  ...
  if (item.type === "video") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { name: item.author, initials: item.authorInitials, timeAgo: item.timeAgo }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.poster, alt: item.title, loading: "lazy", className: "w-full aspect-video object-cover rounded-xl ring-1 ring-black/5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-14 rounded-full bg-background/95 ring-1 ring-black/10 grid place-items-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "size-6 ml-0.5 fill-foreground text-foreground" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-2 right-2 bg-black/70 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded", children: item.duration }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-2 left-2 bg-brand text-brand-foreground text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded", children: "Filme" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold leading-tight text-balance mb-1", children: item.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-pretty mb-3", children: item.excerpt }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SocialActions, { id: item.id, title: item.title })
...
function SocialActions({
  ...
  const params2 = useOperationalParams();
  const closeShare = () => {
    setShareOpen(false);
    setTimeout(() => {
      setStep("channels");
  ...
  const handleLike = () => {
    setLiked((v) => {
      const next = !v;
      if (next) {
        if (isOwnPost2 || params2.blockSelfEngagementRewards) {
          toast.warning("🔒 Antifraude: Curtir seu próprio post não acumula pontos nfs.");
        } else {
          wallet.earn(params2.nfsPerLike, `Curtida em post de terceiro: ${title}`);
          sharedSandboxStore.rewardEngagement("like", title);
          toast.success(`+${params2.nfsPerLike} nfs acumulados por curtir post de terceiro!`);
        }
      }
      return next;
    });
  ...
  const handleCompleteView = () => {
    if (!viewed) {
      ...
      if (isOwnPost2) {
        ...
        wallet.earn(params2.nfsPerPostView, `Visualização completa: ${title}`);
        toast.success(`+${params2.nfsPerPostView} nfs por visualizar post de terceiro!`);
      }
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    ...
    shareOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/40 flex items-end justify-center", onClick: closeShare, role: "dialog", "aria-label": "Compartilhar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-white text-zinc-900 rounded-t-2xl p-5 pb-8 max-h-[85vh] flex flex-col shadow-2xl border-t border-zinc-200", onClick: (e) => e.stopPropagation(), children: [
      ...
      (step === "wpp" || step === "tg" || step === "msg" || step === "ig") && /* @__PURE__ */ jsxRuntimeExports.jsx(ContactSendList, { title, step, sent, setSent }),
