...
import { s as sharedSandboxStore$1, u as useOperationalParams, n as netfitsLogo, A as ALL_KR_MAP, o as operationalParamsStore } from "./router-DL-cbsHV.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-RII740TG.mjs";
import { m as ChartColumn, e as Send, n as FileText, a as Award, o as Coins, p as SlidersVertical, q as Rss, S as ShoppingBag, A as Activity, i as Users, r as Handshake, s as Cpu, D as DollarSign, t as ShieldAlert, T as TrendingUp, u as RefreshCw, v as Lock, w as Layers, C as ChevronDown, x as Clock, y as Download, Z as Zap, R as RotateCcw, z as MousePointerClick, I as Megaphone, l as Eye, J as Store, K as Tag, G as Gift, N as Truck, O as Star, Q as ShoppingCart, V as UserPlus, Y as Funnel, d as Sparkles, _ as Save, j as ShieldCheck, $ as Percent, a0 as UserCheck, a1 as Search, h as Check, X, a2 as PenLine, a3 as LogIn, a4 as Trash2, a5 as CircleCheck, g as Share2, a6 as Phone, a7 as Mail, a8 as ArrowUpRight, a9 as ArrowDownRight, aa as ChevronLeft, ab as ChevronRight } from "../_libs/lucide-react.mjs";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-zinc-850", children: sandboxUsersList.filter((u) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `hover:bg-zinc-900/60 transition ${isCurrentActive ? "bg-purple-950/20" : ""}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-full bg-gradient-to-tr from-purple-700 to-lime-400 grid place-items-center text-white font-black text-xs shrink-0", children: u.fullName.substring(0, 2).toUpperCase() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-4 text-right", children: editingUserId === u.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-bold text-white text-xs", children: [
                    u.nfsBalance.toLocaleString("pt-BR"),
                    " ",
