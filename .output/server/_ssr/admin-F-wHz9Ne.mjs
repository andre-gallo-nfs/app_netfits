...
import { s as sharedSandboxStore, A as ADMIN_PILLARS, c as netfitsLogo, d as ALL_KR_MAP, b as authStore } from "./router-DaDBMgHi.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full space-y-6 overflow-x-hidden", children: [
        ...
        activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          (() => {
            ...
            const breakagePct = operationalParams.targetBreakagePct ?? 12;
        ...
        (activeTab === "results" || activeTab === "controls") && (() => {
          ...
          const expiredPointsCount = Math.round(validIssuedPointsCount * ((operationalParams.targetBreakagePct ?? 12) / 100));
