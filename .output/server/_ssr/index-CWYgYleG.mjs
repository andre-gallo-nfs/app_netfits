...
import { P as ProductDetailSheet } from "./ProductDetailSheet-qF953hAV.mjs";
import { n as netfitsMark } from "./netfits-mark-DN6CUhW7.mjs";
import { s as sharedSandboxStore$1, w as wallet, u as useOperationalParams } from "./router-DHpug7Dm.mjs";
...
function InviteFriendsCard() {
  const activeUser = sharedSandboxStore$1.useActiveUser();
...
function VideoFeedCard({
  ...
  reactExports.useEffect(() => {
    if (isCompleted && !rewarded) {
      ...
      sharedSandboxStore$1.rewardEngagement("view", item.title);
    ...
    setLiked((v) => {
      ...
      if (next) {
        if (isOwnPost || params.blockSelfEngagementRewards) {
          ...
          sharedSandboxStore$1.rewardEngagement("like", title);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          if (!isSent) {
            if (isOwnPost) {
              ...
              sharedSandboxStore$1.rewardEngagement("share", title);
