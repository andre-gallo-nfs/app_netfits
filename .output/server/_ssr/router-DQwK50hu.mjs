...
import { H as House, S as ShoppingBag, A as Activity, a as Award, W as Wallet, F as FlaskConical, R as RotateCcw, C as ChevronDown, b as Copy, U as User, E as ExternalLink, X, c as ArrowRight, d as Sparkles, e as Send } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-CuiCJIF_.css";
...
class HomologationSandboxStore {
  ...
  constructor() {
    ...
    if (typeof window !== "undefined") {
      ...
      setInterval(() => this.syncFromCloud(), 12e3);
    }
  }
  async syncFromCloud() {
        ...
        if (Array.isArray(cloudUsers) && cloudUsers.length > 0) {
          ...
          for (const cu of cloudUsers) {
            const idx = this.state.users.findIndex(
              (u) => u.id === cu.id || u.email && cu.email && u.email.trim().toLowerCase() === cu.email.trim().toLowerCase() || u.identifier && cu.identifier && u.identifier.trim().toLowerCase() === cu.identifier.trim().toLowerCase()
            );
            if (idx >= 0) {
...
const $$splitComponentImporter$d = () => import("./index-CrqiCwZx.mjs");
...
const $$splitComponentImporter$b = () => import("./admin-DUxuYDZL.mjs");
...
const $$splitComponentImporter$a = () => import("./associado-CvSijBfC.mjs");
...
const $$splitComponentImporter$9 = () => import("./auth-CIpy4ucH.mjs");
...
const $$splitComponentImporter$8 = () => import("./contato-9OisYJK8.mjs");
...
const $$splitComponentImporter$7 = () => import("./download-BkpANu4s.mjs");
...
const $$splitComponentImporter$6 = () => import("./faq-KF0klGO5.mjs");
...
const $$splitComponentImporter$5 = () => import("./home-C6Ptbava.mjs");
...
const $$splitComponentImporter$4 = () => import("./levels-BomoDLD0.mjs");
...
const $$splitComponentImporter$3 = () => import("./market-BlyZdNH7.mjs");
...
const $$splitComponentImporter$2 = () => import("./parceiros-CWe50vQQ.mjs");
...
const $$splitComponentImporter$1 = () => import("./profile-CMedULEE.mjs");
...
const $$splitComponentImporter = () => import("./wallet-DgPE3ms1.mjs");
