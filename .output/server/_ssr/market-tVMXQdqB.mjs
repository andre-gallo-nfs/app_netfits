...
import { P as ProductDetailSheet, g as generatePartnerAffiliateUrl } from "./ProductDetailSheet-BCwOVv3x.mjs";
import { a1 as Search, X, Z as Zap, E as ExternalLink } from "../_libs/lucide-react.mjs";
...
function MarketPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-purple-950/40 via-zinc-900 to-zinc-900 border border-purple-500/30 rounded-2xl p-3.5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider bg-purple-500/20 text-purple-300 border border-purple-500/30 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "size-3 text-purple-400" }),
            "Rock Encantech Integrado"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-lime-400 font-bold", children: "4 a 8 nfs por R$ gasto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs sm:text-sm font-bold text-white", children: "Loja Parceira Oficial com Login SSO & Pontos Netfits" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 leading-snug", children: "Ganhe até 8 nfs por R$ gasto (2x no Club) e bônus de 100 nfs na 1ª compra via Rock Encantech." })
      ] }),
      ...
      }, className: "px-3.5 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold flex items-center justify-center gap-1.5 transition active:scale-95 shadow-lg shadow-purple-600/20 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Acessar Loja Parceira" }),
