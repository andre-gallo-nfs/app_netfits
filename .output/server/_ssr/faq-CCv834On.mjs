...
import { a1 as Search, an as Scale, n as FileText, ao as BookOpen, y as Download, j as ShieldCheck, ap as CircleQuestionMark, aq as ChevronUp, C as ChevronDown, a7 as Mail } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-4xl mx-auto px-6 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-zinc-900 via-purple-950/30 to-zinc-900 border-2 border-purple-500/30 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 border border-zinc-800 rounded-2xl p-5 space-y-4 flex flex-col justify-between hover:border-purple-500/40 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-wider text-lime-400 bg-purple-950/60 px-2 py-0.5 rounded-full border border-purple-500/30", children: "Estudo Benchmark · 2026.2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "size-4 text-lime-400" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Comparativo Fidelidade: Stix & Livelo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 leading-relaxed", children: "Estudo comparativo independente de 12 dimensões: regras de pontos, matriz de risco, combate a fraudes e conformidade regulatória." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/docs/Netfits_Estudo_Comparativo_Programas_Fidelidade_Stix_Livelo.docx", download: "Netfits_Estudo_Comparativo_Programas_Fidelidade_Stix_Livelo.docx", target: "_blank", rel: "noopener noreferrer", className: "flex-1 py-2.5 px-3 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition cursor-pointer shadow-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-3.5 text-lime-400" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Baixar Estudo (.DOCX)" })
          ] }) })
        ] })
      ] })
    ] }) }),
