...
import { n as netfitsLogo, s as sharedSandboxStore } from "./router-Bw2N_R5E.mjs";
...
import { a2 as Lock, a3 as LogIn, a4 as UserPlus, V as Percent, f as Check, b as Copy, g as Share2, U as Users, S as ShoppingBag, n as Coins, D as DollarSign, d as Sparkles, w as Download, j as Eye, a5 as Video, A as Activity, a as Award } from "../_libs/lucide-react.mjs";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-center items-center px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-zinc-900 border border-purple-500/30 rounded-3xl p-8 shadow-2xl space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-black text-white tracking-tight", children: "Acesso do Associado — Netfits" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400", children: "Digite suas credenciais ou credencie-se como novo Associado parceiro." })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 border-t border-zinc-800 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mb-2", children: "Ainda não tem cadastro de Associado?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setShowRegModal(true), className: "w-full py-3 rounded-xl font-extrabold text-xs bg-lime-400 text-black hover:bg-lime-300 transition-all shadow-sm flex items-center justify-center gap-2", children: [
