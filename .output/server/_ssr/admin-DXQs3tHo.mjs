...
import { u as useOperationalParams, o as operationalParamsStore } from "./index.mjs";
import { s as sharedSandboxStore, A as ADMIN_PILLARS, c as netfitsLogo, d as ALL_KR_MAP, b as authStore } from "./router-DIJZWtNc.mjs";


import "../_libs/seroval.mjs";
import { x as ChartColumn, y as DollarSign, z as FileText, d as Sparkles, I as Cpu, A as Activity, g as Users, a as Award, J as Handshake, K as SlidersVertical, N as Coins, O as Rss, S as ShoppingBag, Z as Zap, i as Send, C as ChevronDown, V as TrendingUp, v as Lock, D as Download, Y as RefreshCw, _ as CircleCheck, c as ShieldCheck, $ as Clock, R as RotateCcw, a0 as MousePointerClick, w as Flame, a1 as Megaphone, o as Eye, a2 as Store, s as Tag, G as Gift, T as Truck, q as Star, a3 as ShoppingCart, a4 as UserPlus, a5 as Funnel, a6 as ShieldAlert, a7 as Save, a8 as UserCheck, a9 as Search, k as Check, X, aa as PenLine, ab as LogIn, ac as Trash2, ad as Archive, ae as Database, l as Share2, af as Phone, M as Mail, ag as KeyRound, h as ArrowRight, ah as ArrowUpRight, ai as ArrowDownRight, aj as ChevronLeft, ak as ChevronRight, E as ExternalLink, al as Key, b as Copy, am as Server, an as CodeXml, P as Play } from "../_libs/lucide-react.mjs";
...
const coldTierStore = {
  ...
  async triggerColdArchiving() {
    ...
    currentState = {
      ...currentState,
      hotLedgerRows: Math.max(5e3, currentState.hotLedgerRows - batch),
      coldArchivedRows: currentState.coldArchivedRows + batch,
      hotStorageMb: Math.max(5, Number((currentState.hotStorageMb - freed).toFixed(2))),
...
class QaAutonomousEngine {
  ...
  async runFullBattery(onProgress) {
    this.isRunning = true;
...
const ADMIN_MASTER_PIN = "202626";
const SESSION_STORAGE_KEY = "netfits_admin_session_unlocked";
function AdminAuthGuard({ children, onUnlocked, onLock }) {
  const [isUnlocked, setIsUnlocked] = reactExports.useState(false);
  const [authMode, setAuthMode] = reactExports.useState("pin");
  const [pin, setPin] = reactExports.useState("");
  const [errorMsg, setErrorMsg] = reactExports.useState("");
  const [email, setEmail] = reactExports.useState("andre.gallo@netfits.com.br");
  ...
  reactExports.useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedAuth === "true" || currentUser?.email === "andre.gallo@netfits.com.br" || currentUser?.email === "andre@netfits.com.br" || currentUser?.email === "gallo@netfits.com.br" || currentUser?.email === "luisa.formigari@netfits.com.br" || currentUser?.email === "luisa@netfits.com.br") {
        setIsUnlocked(true);
  ...
  const handlePasswordLogin = (e) => {
    ...
    const isAuthorizedPassword = cleanPass === "Netfits@2026" || cleanPass === "Netfits#2026" || cleanPass === "Admin@2026" || cleanPass === "202626";
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-zinc-950 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 border-2 border-lime-400 border-t-transparent rounded-full animate-spin" }) });
  }
  if (isUnlocked) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 text-white flex flex-col items-center justify-center p-4 selection:bg-lime-400 selection:text-zinc-950", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-zinc-900/95 border border-zinc-800 rounded-3xl p-8 space-y-6 shadow-2xl backdrop-blur-xl relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-24 -right-24 size-48 bg-lime-500/10 rounded-full blur-3xl pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -left-24 size-48 bg-purple-500/10 rounded-full blur-3xl pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex p-3.5 rounded-2xl bg-gradient-to-br from-zinc-800 to-zinc-950 border border-zinc-700/80 shadow-inner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "size-8 text-lime-400 animate-pulse" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1.5 text-[10px] font-extrabold uppercase tracking-widest text-lime-400 bg-lime-400/10 px-3 py-1 rounded-full border border-lime-400/20 mx-auto w-fit", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-3.5" }),
          "Área Restrita — Netfits Realtime"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-2", children: "Cockpit Administrativo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mt-1", children: "Autenticação obrigatória para acesso à DRE, Take-Rate, OKRs e Parâmetros." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-zinc-950 p-1 rounded-2xl border border-zinc-800 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex-1 py-2 rounded-xl font-bold flex items-center justify-center gap-1.5 transition ${authMode === "pin" ? "bg-lime-400 text-zinc-950 shadow-md" : "text-zinc-400 hover:text-white"}`,
          children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex-1 py-2 rounded-xl font-bold flex items-center justify-center gap-1.5 transition ${authMode === "password" ? "bg-purple-600 text-white shadow-md" : "text-zinc-400 hover:text-white"}`,
          children: [
    ...
    authMode === "pin" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-3", children: [0, 1, 2, 3, 4, 5].map((idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `size-11 rounded-2xl border flex items-center justify-center text-xl font-bold transition-all duration-200 ${pin.length > idx ? "bg-lime-500/20 border-lime-400 text-lime-400 shadow-md shadow-lime-500/20 scale-105" : "bg-zinc-950/80 border-zinc-800 text-zinc-600"}`,
          children: pin.length > idx ? "•" : ""
        },
        idx
      )) }),
      errorMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-400 text-center font-semibold animate-pulse", children: errorMsg }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2.5 pt-1", children: [
        ["1", "2", "3", "4", "5", "6", "7", "8", "9"].map((digit) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    authMode === "password" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePasswordLogin, className: "space-y-4 animate-in fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-zinc-300", children: "E-mail Corporativo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "email",
      ...
      errorMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-400 text-center font-semibold", children: errorMsg }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "submit",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center pt-2 border-t border-zinc-800/80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-zinc-500", children: [
      "Acesso auditado por telemetria e em conformidade com as diretrizes de segurança da ",
...
function AdminMkplaceIntegrationTab() {
  const params = useOperationalParams();
  const [selectedUserId, setSelectedUserId] = reactExports.useState("usr_101");
  ...
  const [decodedJwt, setDecodedJwt] = reactExports.useState(null);
  const [isGeneratingToken, setIsGeneratingToken] = reactExports.useState(false);
  const [profileResult, setProfileResult] = reactExports.useState(null);
  const [isLoadingProfile, setIsLoadingProfile] = reactExports.useState(false);
  const [walletResult, setWalletResult] = reactExports.useState(null);
  const [isLoadingWallet, setIsLoadingWallet] = reactExports.useState(false);
  const [serverStatus, setServerStatus] = reactExports.useState(null);
  const [isCheckingStatus, setIsCheckingStatus] = reactExports.useState(false);
  const [orderAmount, setOrderAmount] = reactExports.useState("250.00");
  const [isFirstPurchase, setIsFirstPurchase] = reactExports.useState(true);
  const [isClubMember, setIsClubMember] = reactExports.useState(false);
  const [webhookResult, setWebhookResult] = reactExports.useState(null);
  const [isSubmittingWebhook, setIsSubmittingWebhook] = reactExports.useState(false);
  const [copiedToken, setCopiedToken] = reactExports.useState(false);
  reactExports.useEffect(() => {
    checkServerStatus();
  }, []);
  ...
  const simulateLocalToken = () => {
    ...
    const mockJwt = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Im5ldGZpdHMtbWtwbGFjZS1rZXktMjAyNiJ9." + btoa(JSON.stringify(mockClaims.payload)) + ".MOCK_RS256_SIGNATURE_NETFITS_SECURITY_READY";
    setJwtToken(mockJwt);
  ...
  const handleSimulateWebhook = async () => {
    const numAmount2 = parseFloat(orderAmount) || 250;
    ...
    try {
      ...
      if (res.ok) {
        ...
        simulateLocalWebhook(numAmount2);
      }
    } catch {
      simulateLocalWebhook(numAmount2);
    } finally {
  ...
  const simulateLocalWebhook = (amount) => {
    ...
    const takeRateAmount = amount * ((params?.netfitsTakeRatePctFromGmv || 6) / 100);
    const referralAmount = amount * ((params?.normalUserReferralSharePct || 5) / 100);
    const mockRes = {
      success: true,
      orderId: `ped_mkp_${Date.now().toString().slice(-5)}`,
      customerId: activeUser.id,
      ...
      financialSummary: {
        ...
        netfitsTakeRateAmount: `R$ ${takeRateAmount.toFixed(2)} (${params?.netfitsTakeRatePctFromGmv || 6}%)`,
        friendReferralCommission: `R$ ${referralAmount.toFixed(2)} (${params?.normalUserReferralSharePct || 5}%)`,
  ...
  const previewTakeRate = numAmount * ((params?.netfitsTakeRatePctFromGmv || 6) / 100);
  const previewReferral = numAmount * ((params?.normalUserReferralSharePct || 5) / 100);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-zinc-900 via-zinc-900 to-purple-950/40 border border-purple-500/30 rounded-2xl p-6 shadow-xl relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-80 h-80 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-purple-500/20 text-purple-300 border border-purple-500/30 flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "size-3 text-purple-400" }),
              "Rock Encantech / Mkplace"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-3 text-emerald-400" }),
              "Estrutura 100% Pronta"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-amber-500/20 text-amber-300 border border-amber-500/30", children: "Aguardando Credenciais Oficiais" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl md:text-2xl font-black text-white tracking-tight flex items-center gap-2", children: "Integração de Lojas & SSO — Rock Encantech" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs md:text-sm text-zinc-400 max-w-2xl leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: `size-3.5 ${isCheckingStatus ? "animate-spin text-purple-400" : ""}` }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 pt-6 mt-6 border-t border-zinc-800", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "Acúmulo Base" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-lime-400", children: [
            params?.nfsEarnedPerBrlSpent || 4,
            " nfs / R$"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "Netfits Club (2x)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-purple-400", children: [
            (params?.nfsEarnedPerBrlSpent || 4) * 2,
            " nfs / R$"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "1ª Compra Shop" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-amber-400", children: [
            "+",
            params?.shopFirstPurchaseBonusNfs || 100,
            " nfs"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "Take Rate Netfits" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-cyan-400", children: [
            params?.netfitsTakeRatePctFromGmv || 6,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "Comissão Amigo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-blue-400", children: [
            params?.normalUserReferralSharePct || 5,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-800/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-400 block", children: "Paridade Ponto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black text-emerald-400", children: [
            "R$ ",
            (params?.cppResgateBrl || 0.1).toFixed(2)
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-lg space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold text-white flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "size-4 text-purple-400" }),
              "1. Emissão de Token SSO (JWT RS256)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono px-2 py-0.5 rounded bg-zinc-800 text-zinc-400", children: "kid: netfits-2026" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-semibold text-zinc-400 mb-1.5 block", children: "Selecione o Usuário para Simulação:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: TEST_PERSONAS.map((user) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `p-2.5 rounded-xl border text-left transition ${isSelected ? "bg-purple-950/40 border-purple-500 text-white shadow-md" : "bg-zinc-950/60 border-zinc-800 text-zinc-400 hover:border-zinc-700"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-xs truncate", children: user.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-zinc-400 truncate", children: user.role }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-mono text-lime-400 mt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                isGeneratingToken ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { className: "size-4" }),
                "Gerar Token JWT RS256 para ",
                activeUser.name
              ]
            }
          ),
          jwtToken && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-zinc-400", children: "Token JWT Assinado (Bearer):" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      copiedToken ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "size-3 text-emerald-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "size-3" }),
                      copiedToken ? "Copiado!" : "Copiar"
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 bg-zinc-950 rounded-xl border border-zinc-800 font-mono text-[10px] text-purple-300 break-all max-h-24 overflow-y-auto", children: jwtToken })
            ] }),
            decodedJwt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-zinc-400 block", children: "Claims Oficiais Decodificadas:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-zinc-950 rounded-xl border border-zinc-800 font-mono text-[10px] text-zinc-300 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "sub:" }),
                  " ",
                  decodedJwt.payload.sub
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "storeId:" }),
                  " ",
                  decodedJwt.payload.storeId
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "accountId:" }),
                  " ",
                  decodedJwt.payload.accountId
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "roles:" }),
                  " ",
                  JSON.stringify(decodedJwt.payload.realm_access.roles)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "exp:" }),
                  " ",
                  new Date(decodedJwt.payload.exp * 1e3).toLocaleString(),
                  " (8h)"
                ] })
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-lg space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold text-white flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "size-4 text-cyan-400" }),
            "Credenciais Solicitadas à Rock Encantech"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-400", children: [
            "Assim que a equipe da Rock Encantech enviar os parâmetros, basta preenchê-los no arquivo ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-purple-300", children: ".env" }),
            ":"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs font-mono", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-zinc-950 rounded-lg border border-zinc-800 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400", children: "MKPLACE_ENV" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400 font-bold", children: "production" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-zinc-950 rounded-lg border border-zinc-800 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400", children: "MKPLACE_STORE_ID" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-300", children: "[Aguardando Envio]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-zinc-950 rounded-lg border border-zinc-800 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400", children: "MKPLACE_ACCOUNT_ID" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-300", children: "[Aguardando Envio]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-zinc-950 rounded-lg border border-zinc-800 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400", children: "MKPLACE_WEBVIEW_URL" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-400 truncate max-w-[200px]", children: "https://[loja].mkplace.com.br" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-lg space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold text-white flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "size-4 text-lime-400" }),
              "2. Teste dos Endpoints Padronizados Mkplace"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold px-2 py-0.5 rounded bg-lime-500/20 text-lime-300 border border-lime-500/30", children: "Mock Local Ativo" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-purple-500/10 text-purple-400 group-hover:bg-purple-500/20 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { className: "size-4" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-white flex items-center gap-1.5", children: [
                      "GET /customer/profile",
                      isLoadingProfile && /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-3 animate-spin text-purple-400" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Obtém nome, CPF, endereço e telefone para entrega." })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: "p-3 rounded-xl bg-zinc-950 hover:bg-zinc-800/80 border border-zinc-800 text-left transition flex items-start gap-3 group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-lime-500/10 text-lime-400 group-hover:bg-lime-500/20 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "size-4" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-white flex items-center gap-1.5", children: [
                      "GET /loyalty/wallet",
                      isLoadingWallet && /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-3 animate-spin text-lime-400" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Consulta saldo de netfits e paridade em reais." })
                  ] })
                ]
              }
            )
          ] }),
          profileResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-2 border-t border-zinc-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-zinc-300", children: "Resposta: GET /customer/profile" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-emerald-400 font-mono", children: "200 OK · Schema Validado" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-3 bg-zinc-950 rounded-xl border border-zinc-800 text-[11px] text-zinc-300 font-mono max-h-40 overflow-y-auto", children: JSON.stringify(profileResult, null, 2) })
          ] }),
          walletResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-2 border-t border-zinc-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-zinc-300", children: "Resposta: GET /loyalty/wallet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-emerald-400 font-mono", children: "200 OK · Saldo Sincronizado" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-3 bg-zinc-950 rounded-xl border border-zinc-800 text-[11px] text-zinc-300 font-mono max-h-40 overflow-y-auto", children: JSON.stringify(walletResult, null, 2) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-lg space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold text-white flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "size-4 text-amber-400" }),
              "3. Simulador de Pedido Concluído (Webhook Rock Encantech)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 border border-amber-500/30", children: "Take Rate 6%" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-zinc-400 font-medium block mb-1", children: "Valor do Pedido (R$)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-2.5 text-xs text-zinc-500", children: "R$" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer p-2 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "checkbox",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-zinc-300 font-medium", children: "1ª Compra (+100 nfs)" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer p-2 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-zinc-300 font-medium", children: "Netfits Club (2x nfs)" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3.5 rounded-xl border border-zinc-800/80 space-y-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold text-zinc-300 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Cálculo Prévia do Pedido:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-amber-400 font-mono font-bold", children: [
                previewPoints.toLocaleString(),
                " nfs"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-[11px] pt-2 border-t border-zinc-900 text-zinc-400", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-zinc-500", children: "Valor em Pontos:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-lime-400", children: [
                  "R$ ",
                  (previewPoints * (params?.cppResgateBrl || 0.1)).toFixed(2)
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-zinc-500", children: "Take Rate Netfits (6%):" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-cyan-400", children: [
                  "R$ ",
                  previewTakeRate.toFixed(2)
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-zinc-500", children: "Indicação Amigo (5%):" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-blue-400", children: [
                  "R$ ",
                  previewReferral.toFixed(2)
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                isSubmittingWebhook ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "size-4" }),
                "Disparar Webhook de Pedido Faturado (POST /api/marketplace/mkplace/webhook)"
              ]
            }
          ),
          webhookResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-2 border-t border-zinc-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-zinc-300", children: "Confirmação do Webhook Processado" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-emerald-400 font-mono", children: "Sucesso · Saldo Atualizado" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-3 bg-zinc-950 rounded-xl border border-zinc-800 text-[11px] text-zinc-300 font-mono max-h-40 overflow-y-auto", children: JSON.stringify(webhookResult, null, 2) })
          ] })
        ] })
      ] })
    ] })
...
function AdminDashboardPage() {
  ...
  const [sandboxUsersList, setSandboxUsersList] = reactExports.useState(() => sharedSandboxStore.getUsers());
  ...
  const [qaProgressStep, setQaProgressStep] = reactExports.useState("");
  const [qaProgressPercent, setQaProgressPercent] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminAuthGuard, { onUnlocked: () => setIsAuthenticated(true) });
  }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row min-h-[calc(100vh-57px)] w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full space-y-6 overflow-x-hidden", children: [
        ...
        activeTab === "qa" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-950/80 via-zinc-900 to-zinc-950 border border-purple-500/40 rounded-3xl p-6 shadow-2xl space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 max-w-2xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-zinc-300 bg-zinc-800/80 px-2.5 py-0.5 rounded-full border border-zinc-700 flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-2 rounded-full bg-lime-400 animate-pulse" }),
                    "Última Bateria: ",
                    qaResult?.timestamp ? new Date(qaResult.timestamp).toLocaleString("pt-BR", {
                      dateStyle: "short",
                      timeStyle: "medium"
                    }) : "Carregando..."
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleTriggerQaBattery, disabled: isExecutingQa, className: "px-5 py-3 rounded-2xl bg-lime-500 hover:bg-lime-400 text-zinc-950 font-black text-xs flex items-center gap-2 shadow-lg shadow-lime-500/20 transition cursor-pointer disabled:opacity-50 active:scale-98", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isExecutingQa ? "Auditando Sistema com IA..." : "Executar Bateria de QA com IA" })
              ] }) })
            ] }),
            (isExecutingQa || qaProgressStep) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/90 border border-lime-500/30 rounded-2xl p-4 space-y-2 animate-in fade-in", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-lime-400 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-3.5 animate-spin text-lime-400" }),
                  qaProgressStep
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-bold text-zinc-300", children: [
                  qaProgressPercent,
                  "%"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-800 h-2 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-purple-500 to-lime-400 h-full rounded-full transition-all duration-300", style: {
                width: `${qaProgressPercent}%`
              } }) })
            ] })
          ] }),
        ...
        activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          (() => {
            ...
            const totalPointsLedger = Math.round(18e6 * pf);
            ...
            const breakagePct = operationalParams.targetBreakagePct ?? 5;
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-zinc-950 via-zinc-900 to-purple-950/40 border border-purple-500/40 rounded-3xl p-6 shadow-2xl space-y-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-800 pb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-widest text-lime-400 bg-lime-400/10 px-2.5 py-0.5 rounded-full border border-lime-400/30", children: "CONFORMIDADE CONTÁBIL & FISCAL — CPC 30 / IFRS 15 & CPC 47" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-zinc-300 bg-zinc-800/80 px-2.5 py-0.5 rounded-full border border-zinc-700", children: [
                      "Paridade da Provisão: R$ ",
                      costPerPoint.toFixed(3),
                      " / nfs"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xl font-extrabold text-white flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "size-6 text-lime-400" }),
                    "Monitoramento em Tempo Real do Passivo Circulante de Fidelidade & Burn Rate"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400", children: "Valoração atuarial contínua dos pontos emitidos, velocidade de resgate (burn rate) e reversão contábil por expiração (FEFO 24 meses)." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-zinc-400 block font-bold uppercase", children: "Status de Solvência" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-black text-lime-400 bg-lime-400/10 border border-lime-400/30 px-3 py-1 rounded-full inline-flex items-center gap-1 mt-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-3.5" }),
                    " 100% Solvente & Coberto"
                  ] })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/90 border border-zinc-800 hover:border-purple-500/50 p-4 rounded-2xl space-y-2 transition shadow-lg", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-purple-300 tracking-wider", children: "Passivo Circulante Total" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "size-4 text-purple-400" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-white font-mono", children: [
                    "R$ ",
                    totalProvisionBrl.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2
                    })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-zinc-400 border-t border-zinc-800/80 pt-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pontos em Circulação:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-lime-400 font-mono", children: [
                      totalPointsLedger.toLocaleString("pt-BR"),
                      " nfs"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[9px] font-bold text-purple-300 bg-purple-950/60 border border-purple-500/30 px-2 py-0.5 rounded", children: "Exigibilidade Imediata (CPC 30)" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/90 border border-zinc-800 hover:border-lime-500/50 p-4 rounded-2xl space-y-2 transition shadow-lg", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-lime-400 tracking-wider", children: "Taxa de Queima (Burn Rate)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "size-4 text-lime-400" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-lime-400 font-mono", children: [
                      burnRatePct,
                      "%"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-zinc-400 font-bold", children: "Resgates / Emissões" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-800 h-2 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-purple-500 to-lime-400 h-full rounded-full", style: {
                    width: `${burnRatePct}%`
                  } }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-zinc-400 pt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Resgates no Shop:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-white font-mono", children: [
                      "R$ ",
                      redeemedBrl.toLocaleString("pt-BR", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                      })
                    ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/90 border border-zinc-800 hover:border-amber-500/50 p-4 rounded-2xl space-y-2 transition shadow-lg", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-amber-400 tracking-wider", children: "Reversão (Breakage CPC 47)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "size-4 text-amber-400" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-amber-300 font-mono", children: [
                    "R$ ",
                    breakageBrl.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2
                    })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-zinc-400 border-t border-zinc-800/80 pt-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Taxa Est. de Expiração:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-amber-400 font-mono", children: [
                      breakagePct,
                      "% a.a."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[9px] font-bold text-amber-300 bg-amber-950/60 border border-amber-500/30 px-2 py-0.5 rounded", children: "Reversão Positiva na DRE" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/90 border border-zinc-800 hover:border-cyan-500/50 p-4 rounded-2xl space-y-2 transition shadow-lg", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 tracking-wider", children: "Índice de Cobertura" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-4 text-cyan-400" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-cyan-400 font-mono", children: [
                      coverageRatio,
                      "x"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-zinc-400 font-bold", children: "Grau de Solvência A+" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-zinc-400 border-t border-zinc-800/80 pt-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Reserva de Liquidez:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-white font-mono", children: [
                      "R$ ",
                      reserveCashBrl.toLocaleString("pt-BR", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                      })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[9px] font-bold text-cyan-300 bg-cyan-950/60 border border-cyan-500/30 px-2 py-0.5 rounded", children: "Reserva Segregada para Resgates" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 p-4 rounded-2xl border border-zinc-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-2 rounded-full bg-lime-400 animate-pulse shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-zinc-300", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: "Diretriz Go-Live:" }),
                    " No instante do lançamento oficial com banco limpo (zero-state), o passivo iniciará em ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-lime-400 font-mono", children: "R$ 0,00" }),
                    ", evoluindo estritamente com base em compras confirmadas no Shop e treinos validados."
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("results"), className: "px-3 py-1.5 rounded-xl bg-purple-900/50 hover:bg-purple-800/60 text-purple-300 font-bold border border-purple-500/30 hover:text-white transition cursor-pointer text-xs", children: "Ver DRE Projetada →" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("xml"), className: "px-3 py-1.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-bold border border-zinc-700 transition cursor-pointer text-xs", children: "XML / SPED Contábil →" })
                ] })
              ] })
            ] });
          })(),
        ...
        activeTab === "mkplace" && /* @__PURE__ */ jsxRuntimeExports.jsx(AdminMkplaceIntegrationTab, {}),
        ...
        activeTab === "params" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveParams, className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-purple-500/30 rounded-2xl p-4 shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-3 bg-gradient-to-r from-purple-950/40 via-zinc-900 to-zinc-900", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-extrabold uppercase tracking-wider text-lime-400 bg-lime-400/10 px-2 py-0.5 rounded border border-lime-400/20", children: "Tabela de Dados Mestres (system_parameters)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] font-bold text-emerald-400 flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white", children: "Ponto Central de Parametrização Operacional & Economia dos Pontos" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Qualquer alteração salva aqui atualiza a tabela de dados mestres em tempo real e reflete instantaneamente no Feed, Shop, Carteira e DRE." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 self-start md:self-auto shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-purple-500/30 rounded-3xl p-6 shadow-xl space-y-6 lg:col-span-2 bg-gradient-to-r from-purple-950/40 via-zinc-900 to-zinc-900", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 bg-zinc-950/60 p-4 rounded-2xl border border-zinc-800", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por Post Próprio (vídeo, foto ou texto)", unit: "nfs / post", value: operationalParams.nfsPerOwnPost ?? 10, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    nfsPerOwnPost: Number(v),
                    nfsPerVideoPost: Number(v),
                    nfsPerTextPost: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Limite diário de posts próprios pontuáveis", unit: "post / dia", value: operationalParams.dailyRewardedPostLimit, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    dailyRewardedPostLimit: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Limite semanal de posts próprios pontuáveis", unit: "posts / semana", value: operationalParams.weeklyRewardedPostLimit, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 bg-zinc-950/60 p-4 rounded-2xl border border-zinc-800", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por view de posts", unit: "nfs / view", value: operationalParams.nfsPerPostView, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    nfsPerPostView: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por click em link de posts", unit: "nfs / clique", value: operationalParams.nfsPerLinkClick ?? 10, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    nfsPerLinkClick: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Limite máximo de interações com posts de terceiros", unit: "interações / dia", value: operationalParams.dailyThirdPartyInteractionsLimit, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-purple-500/30 rounded-3xl p-6 shadow-xl space-y-5 lg:col-span-2 bg-gradient-to-r from-purple-950/30 via-zinc-900 to-zinc-900", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between border-b border-zinc-800 pb-3 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-5 text-lime-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-widest text-lime-400", children: "Regras Diferenciadas de Remuneração" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-base text-white", children: "Programa de Indicação & Comissionamento de Indicados" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-lime-300 bg-lime-500/10 px-3 py-1 rounded-full border border-lime-500/20 flex items-center gap-1.5 self-start sm:self-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-3.5 text-lime-400" }),
                  "Regra Estrutural de Negócio"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-zinc-950/80 border border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 p-3 rounded-xl bg-blue-500/5 border border-blue-500/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-blue-400 font-black uppercase text-[10px] tracking-wider", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "👤" }),
                    " Usuário Comum (Atleta Free)"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-300 leading-snug", children: [
                    "O indicador recebe ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "50 nfs" }),
                    " uma única vez por cada novo usuário cadastrado usando seu código. Embora a marcação seja ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "permanente" }),
                    " no banco, ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "esta premiação será a única" }),
                    " que o indicador comum receberá."
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 p-3 rounded-xl bg-amber-500/5 border border-amber-500/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-amber-400 font-black uppercase text-[10px] tracking-wider", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⭐" }),
                    " Assinante Netfits Club (Upgrade)"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-300 leading-snug", children: [
                    "A regra só se altera se o usuário ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "assinar o Clube" }),
                    ". Ao virar assinante, passa aí sim a ganhar ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "10% de comissão em pontos" }),
                    " sobre todos os pontos ganhos nas compras do shop feitas pelos seus indicados."
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 p-3 rounded-xl bg-purple-500/5 border border-purple-500/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-purple-400 font-black uppercase text-[10px] tracking-wider", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🏢" }),
                    " Associados (Carteira Compartilhada)"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-300 leading-snug", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Esta limitação NÃO se aplica aos Associados" }),
                    ". Seus indicados estão sempre presentes na sua ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Carteira Compartilhada perpétua" }),
                    ", recebendo repasse contínuo de ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "10% das receitas" }),
                    " geradas por eles."
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Pontos por indicação de novo usuário (usuário comum)", unit: "nfs / novo usuário", value: operationalParams.normalUserNewReferralBonusNfs ?? 50, onChange: (v) => setOperationalParams((p) => ({
                  ...p,
                  normalUserNewReferralBonusNfs: Number(v)
                })) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Comissão pontos shop indicados (assinante Clube)", unit: "% dos pontos do shop", value: operationalParams.clubMemberReferralShopPointsPct ?? 10, onChange: (v) => setOperationalParams((p) => ({
                  ...p,
                  clubMemberReferralShopPointsPct: Number(v),
                  normalUserReferralSharePct: Number(v)
                })) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Repasse receitas Carteira Compartilhada (Associados)", unit: "% da receita gerada", value: operationalParams.associadoShareOfNetfitsRevenuePct, onChange: (v) => setOperationalParams((p) => ({
                  ...p,
                  associadoShareOfNetfitsRevenuePct: Number(v)
                })) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-lime-500/30 rounded-3xl p-6 shadow-xl space-y-5 lg:col-span-2 bg-gradient-to-r from-lime-950/20 via-zinc-900 to-zinc-900", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between border-b border-zinc-800 pb-3 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "size-5 text-lime-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-widest text-lime-400", children: "Motor Biométrico & Sweat-to-Earn" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-base text-white", children: "Atividades Físicas, Wearables & Regras de Treino" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-lime-400 bg-lime-500/10 px-3 py-1 rounded-full border border-lime-500/20 flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-3.5 text-lime-400" }),
                  "Validação Biometria / GPS Ativa"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 bg-zinc-950/60 p-4 rounded-2xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-xs font-black text-lime-400 uppercase tracking-wider flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🏃 Parâmetros de Recompensa & Limites de Frequência" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por Atividade Executada (GPS/Sensores)", unit: "nfs / treino", value: operationalParams.nfsPerWorkout ?? 20, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    nfsPerWorkout: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Limite semanal de treinos pontuáveis", unit: "treinos / semana", value: operationalParams.weeklyMaxRewardedWorkouts ?? 5, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    weeklyMaxRewardedWorkouts: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Limite diário de treinos pontuáveis", unit: "treino / dia", value: operationalParams.dailyMaxRewardedWorkouts ?? 1, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    dailyMaxRewardedWorkouts: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Bônus Semanal de Consistência (Streak)", unit: "nfs bônus", value: operationalParams.workoutStreakBonusNfs ?? 20, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    workoutStreakBonusNfs: Number(v)
                  })) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 bg-zinc-950/60 p-4 rounded-2xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-xs font-black text-purple-300 uppercase tracking-wider flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⏱️ Critérios de Duração, Biometria & Ingestão" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Duração Mínima Treino Geral", unit: "minutos", value: operationalParams.minWorkoutDurationMinutes ?? 30, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    minWorkoutDurationMinutes: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Duração Mínima Treino HIIT", unit: "minutos", value: operationalParams.minWorkoutDurationHiitMinutes ?? 20, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    minWorkoutDurationHiitMinutes: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Gasto Calórico Mínimo Ativo", unit: "kcal ativas", value: operationalParams.minWorkoutActiveCalories ?? 150, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    minWorkoutActiveCalories: Number(v)
                  })) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "Janela Máx. Sincronia Retroativa", unit: "horas", value: operationalParams.maxRetroactiveSyncHours ?? 48, onChange: (v) => setOperationalParams((p) => ({
                    ...p,
                    maxRetroactiveSyncHours: Number(v)
                  })) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 bg-purple-950/30 p-4 rounded-2xl border border-purple-500/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-xs font-black text-white uppercase tracking-wider flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-4 text-lime-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Matriz de Governança Antifraude de Sensores & Wearables" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-red-400 block", children: "🚫 Bloqueio Treino Manual" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-400 leading-snug", children: [
                      "Entradas manuais no Strava/Apple sem dados brutos de GPS ou frequência cardíaca são ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "automaticamente descartadas (0 nfs)" }),
                      "."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-purple-500/40 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-amber-400 block", children: "🚗 Filtro Anti-Automotivo" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-400 leading-snug", children: [
                      "Corridas com ritmo abaixo de ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "2:15 min/km (>26,6 km/h)" }),
                      " ou ciclismo contínuo acima de ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "55 km/h" }),
                      " caem em auditoria manual."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-blue-400 block", children: "🛡️ Teto Diário Anti-Split" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-400 leading-snug", children: [
                      "Apenas ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "1 atividade por dia" }),
                      " pontua, coibindo a divisão de um treino longo em vários blocos para burlar a pontuação."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-lime-400 block", children: "📈 Bônus Golden Streak" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-zinc-400 leading-snug", children: [
                      "Prêmio adicional de ",
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("b", { children: [
                        "+",
                        operationalParams.workoutStreakBonusNfs ?? 20,
                        " nfs"
                      ] }),
                      " concedido ao atleta que atinge os 5 treinos semanais."
                    ] })
                  ] })
                ] })
              ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl space-y-4 lg:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b border-zinc-800 pb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "size-5 text-amber-400" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm text-white", children: "Atribuição Comercial, Fidelidade Bancária & Shopping" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ParamInput, { label: "nfs por Vínculo Fidelidade (Stix/Livelo)", unit: "nfs / vínculo", value: operationalParams.nfsPerLoyaltyDeclaration, onChange: (v) => setOperationalParams((p) => ({
                  ...p,
        ...
        activeTab === "activities" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-4 shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-lime-400 bg-lime-400/10 px-3 py-1 rounded-full border border-lime-400/20 font-bold", children: [
              "+",
              operationalParams.nfsPerWorkout || 25,
              " nfs / treino validado"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-zinc-850", children: sandboxUsersList.filter((u) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `hover:bg-zinc-900/60 transition ${isCurrentActive ? "bg-purple-950/20" : ""}`, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => sharedSandboxStore.setActiveUser(u.id), className: `px-2.5 py-1 rounded-lg text-[10px] font-extrabold flex items-center gap-1 transition cursor-pointer ${isCurrentActive ? "bg-lime-400 text-zinc-950 font-black shadow-xs" : "bg-purple-600 hover:bg-purple-500 text-white shadow-xs"}`, title: "Assumir esta conta de teste como sessão ativa", children: [
        ...
        activeTab === "controls" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-cyan-500/30 rounded-3xl p-6 shadow-xl space-y-5 w-full bg-gradient-to-r from-cyan-950/30 via-zinc-900 to-blue-950/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between border-b border-cyan-500/20 pb-4 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-black uppercase tracking-widest text-cyan-400 bg-cyan-400/10 px-3 py-1 rounded-full border border-cyan-400/20 flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Archive, { className: "size-3 text-cyan-400" }),
                    "Estratégia FinOps: Armazenamento & Banco de Dados"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-emerald-400 bg-emerald-400/10 px-2.5 py-0.5 rounded-full border border-emerald-400/20 font-bold", children: "SLA Ledger < 10ms" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-base font-black text-white flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "size-5 text-cyan-400" }),
                  "Cold Data Tiering: Ledger de NFS > 24 Meses (PostgreSQL + Cloudflare R2)"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-300", children: "Expurgo automatizado e arquivamento a frio de transações com mais de 24 meses. Previne inchaço de RAM/IOPS na nuvem e preserva trilha imutável no R2 a custo quase zero." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-end sm:items-center gap-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", disabled: coldTier.isArchiving, onClick: async () => {
                await coldTierStore.triggerColdArchiving();
              }, className: `px-4 py-2.5 rounded-xl font-extrabold text-xs flex items-center gap-2 transition-all shadow-md cursor-pointer ${coldTier.isArchiving ? "bg-zinc-800 text-zinc-500 border border-zinc-700" : "bg-cyan-500 hover:bg-cyan-400 text-black shadow-cyan-500/20 active:scale-95"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: `size-4 ${coldTier.isArchiving ? "animate-spin text-zinc-500" : "text-black"}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: coldTier.isArchiving ? "Arquivando Lotes..." : "Executar Cold Tiering Agora" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-4 rounded-2xl border border-zinc-800 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-zinc-400 uppercase tracking-wider", children: "🔥 Hot Ledger (< 24 Meses)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-black text-white font-mono", children: coldTier.hotLedgerRows.toLocaleString("pt-BR") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-mono text-cyan-400 font-bold", children: [
                    coldTier.hotStorageMb,
                    " MB"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-500", children: "Na RAM do PostgreSQL com B-Tree ativa." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-4 rounded-2xl border border-zinc-800 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-zinc-400 uppercase tracking-wider", children: "🧊 Cold Archive (> 24 Meses)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-black text-white font-mono", children: coldTier.coldArchivedRows.toLocaleString("pt-BR") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-mono text-lime-400 font-bold", children: [
                    coldTier.coldStorageMb,
                    " MB"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-500", children: "Tiering comprimido Cloudflare R2 (US$ 0,015/GB)." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-4 rounded-2xl border border-zinc-800 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-zinc-400 uppercase tracking-wider", children: "⚡ Latência do Ledger" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-black text-emerald-400 font-mono", children: [
                    coldTier.queryLatencyMs,
                    " ms"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-zinc-500 line-through", children: [
                    coldTier.unoptimizedLatencyMs,
                    " ms"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-500", children: "Aceleração de 95% sem varreduras full-scan." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-4 rounded-2xl border border-zinc-800 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-zinc-400 uppercase tracking-wider", children: "💰 Economia FinOps Mensal" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-black text-lime-400 font-mono", children: [
                    "R$ ",
                    coldTier.costSavedMonthlyBrl.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2
                    })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono bg-lime-950 text-lime-300 px-1.5 py-0.5 rounded", children: [
                    "-",
                    coldTier.ramSavedMb,
                    " MB RAM"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-500", children: "Economia acumulada em instâncias cloud menores." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/40 border border-zinc-800/80 rounded-2xl p-3.5 text-xs text-zinc-300 flex flex-col md:flex-row items-start md:items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-2 rounded-full bg-emerald-400 animate-pulse shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Rotina Periódica:" }),
                  " Execução mensal automática (",
                  coldTier.runsCount,
                  " ciclos realizados). Último ciclo:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-cyan-300", children: coldTier.lastRunAt ? new Date(coldTier.lastRunAt).toLocaleDateString("pt-BR") : "Recente" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-zinc-400", children: [
                "Políticas ativas: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-purple-300 bg-purple-950/50 px-1.5 py-0.5 rounded", children: "archive_expired_wallet_transactions()" })
              ] })
            ] })
          ] })
        ] }),
        (activeTab === "results" || activeTab === "controls") && (() => {
          ...
          const takeRatePct = operationalParams.netfitsTakeRatePctFromGmv ?? 6;
          ...
          const validIssuedPointsCount = Math.round(18e6 * pf);
          ...
          const expiredPointsCount = Math.round(validIssuedPointsCount * ((operationalParams.targetBreakagePct ?? 5) / 100));
          ...
          const dreShoppingRedemptionCost = Math.round(4e6 * (operationalParams.nfsEarnedPerBrlSpent ?? 4) * 0.25 * (operationalParams.cppResgateBrl ?? 0.01) * pf);
          const dreAssociadoCommissionCost = Math.round(dreRevMarketplace * ((operationalParams.associadoShareOfNetfitsRevenuePct ?? 10) / 100));
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-950/90 via-zinc-900 to-zinc-950 border border-purple-500/50 rounded-3xl p-5 sm:p-6 shadow-2xl space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center justify-between gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-purple-300 bg-purple-950/80 px-2 py-0.5 rounded border border-purple-500/30", children: "VPL: R$ 117,9M • TIR: 248%" })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-300 max-w-3xl leading-relaxed", children: [
                    ...
                    ") e consolidação do DRE gerencial da Netfits com as 3 frentes FinOps incorporadas."
                  ] })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 pt-2 border-t border-zinc-800/80", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-lime-400", children: "EBITDA: +R$ 1,7k" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-zinc-500 block", children: "3 meses (Setup FinOps)" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-lime-400", children: "EBITDA: +R$ 6,31M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-zinc-500 block", children: "Margem 60,4%" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono font-bold text-lime-400 uppercase", children: "2028 (Growth)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-zinc-300", children: "2,0M usuários" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-lime-400", children: "EBITDA: +R$ 29,45M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-zinc-500 block", children: "Margem 74,7%" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-zinc-300", children: "2,6M usuários" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-purple-400", children: "EBITDA: +R$ 48,86M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-zinc-500 block", children: "Margem 71,2%" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-purple-400", children: "EBITDA: +R$ 68,87M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-zinc-500 block", children: "Margem 65,6%" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-lime-950/60 to-purple-950/60 p-3 rounded-2xl border border-lime-500/40 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-white", children: "Receita R$ 241,0M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black text-lime-400", children: "EBITDA: R$ 153,5M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-purple-300 block", children: "Margem 69,0% (+R$ 810k)" })
                ] })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-950/80 via-zinc-900 to-indigo-950/80 p-4 rounded-2xl border border-lime-400/40 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-lime-400", children: "Impacto FinOps Incorporado à DRE (+R$ 1.586.418,16 /ano Economizados)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white font-bold", children: "Otimizações FinOps Ativas: -55.5% em Tokens de IA (Fast-Path/Cache), -70.7% em Auth/OTP (Passkeys FIDO2) e -46.1% em Banco de Dados (Cold Tiering R2)." })
                ] })
              ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-zinc-800/80 font-medium", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-purple-950/20 transition text-purple-300 font-semibold", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2.5 px-4 text-right text-purple-300", children: [
                      "-",
                      (990 * pf / dreGrossRev * 100).toFixed(2),
                      "%"
                    ] }),
        ...
        pitchSlide === 14 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-2xl border border-emerald-400/30 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-300 font-bold block", children: "Breakage (5% a.a.)" }),
...
function getKrHistoricalSeries(code, timeframe, currentNum, targetNum) {
  ...
  return categories.map((cat, i) => {
    ...
    const baseVal = isDecreaseTarget ? targetNum * 1.35 - targetNum * 0.35 * progressRatio : targetNum * 0.65 + (currentNum - targetNum * 0.65) * Math.pow(progressRatio, 0.85);
