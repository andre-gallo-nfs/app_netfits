...
import { e as InstitutionalWebHeader } from "./router-OtdzUaKH.mjs";
import "../_libs/sonner.mjs";
import "./index.mjs";


import "../_libs/seroval.mjs";
import { a9 as Search, az as Scale, z as FileText, aA as BookOpen, D as Download, c as ShieldCheck, j as CircleQuestionMark, aB as ChevronUp, C as ChevronDown, M as Mail } from "../_libs/lucide-react.mjs";
...
const FAQ_ITEMS = [{
  ...
  answer: "Nas compras realizadas no Netfits Shop através de nossos agregadores parceiros, o usuário ganha 4,00 pontos nfs para cada R$ 1,00 pago em dinheiro. O valor do cashback entra como pendente e é liberado na carteira após o prazo legal de arrependimento (7 a 14 dias). Usuários do Netfits Club recebem o dobro (8,00 nfs por R$ 1,00)."
}, {
  id: "faq_3",
  category: "shop",
  categoryLabel: "Netfits Shop & Cashback",
  ...
  answer: "No aplicativo Netfits, acesse a aba 'Atividades' (/activities) e clique em 'Conectar Wearable'. O app permite a sincronização com 1 toque das suas métricas de treino (corrida, ciclismo, musculação) concedendo bônus automáticos de +25 nfs por treino validado."
}, {
  id: "faq_7",
  category: "club",
  categoryLabel: "Netfits Club",
  question: "O que é o Netfits Club e quais são as vantagens da assinatura de R$ 19,90/mês?",
  answer: "O Netfits Club é o clube de benefícios e saúde da Fase 2 do ecossistema Netfits. Por R$ 19,90/mês, os membros ganham cashback em dobro no Shop (8,00 nfs por R$ 1,00 gasto), bônus de 100 nfs na 1ª compra, desconto em exames de check-up e prioridade em inscrições de corridas de rua."
}];
function FaqPage() {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 border border-zinc-800 rounded-2xl p-5 space-y-4 flex flex-col justify-between hover:border-purple-500/40 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-wider text-purple-400 bg-purple-950/60 px-2 py-0.5 rounded-full border border-purple-500/30", children: "Parte I · Regulamento & Termos" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "size-4 text-purple-400" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Regulamento Oficial & Regras Antifraude" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 leading-relaxed", children: "Termos e condições de uso, acúmulo de pontos nfs, regra de 100% dwell time em vídeos, estorno híbrido CDC e cancelamento por inatividade." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/docs/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).docx", download: "Regulamento Oficial, Termos e Condições de uso e Consentimento para o uso de dados (LGPD).docx", target: "_blank", rel: "noopener noreferrer", className: "py-2.5 px-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center justify-center gap-1.5 transition cursor-pointer", title: "Baixar Regulamento Oficial em formato Word (.docx)", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 border border-zinc-800 rounded-2xl p-5 space-y-4 flex flex-col justify-between hover:border-lime-500/40 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Consentimento para Uso de Dados (LGPD)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 leading-relaxed", children: "Bases legais desacopladas, telemetria esportiva protegida (HealthKit/Garmin), garantia de não-venda de dados de saúde e canal do DPO." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/docs/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).docx", download: "Regulamento Oficial, Termos e Condições de uso e Consentimento para o uso de dados (LGPD).docx", target: "_blank", rel: "noopener noreferrer", className: "py-2.5 px-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center justify-center gap-1.5 transition cursor-pointer", title: "Baixar Minuta Oficial e Termo LGPD em formato Word (.docx)", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-3.5 text-lime-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ".DOCX" })
            ] })
          ] })
    ...
    showRegulamentoModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl bg-zinc-900 border border-purple-500/40 rounded-3xl p-6 shadow-2xl space-y-4 max-h-[90vh] flex flex-col text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-5 text-xs text-zinc-300 leading-relaxed pr-3 border-b border-zinc-800 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-950/40 border border-purple-500/30 p-4 rounded-2xl text-[11px] text-purple-200 space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "CNPJ/MF nº 68.930.455/0001-40 · Alameda das Embaúbas, 365, Quadra 06 Lote 19 sala 01, Alphaville, Santana de Parnaíba/SP - CEP 06.542-195." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-disc pl-5 space-y-1 text-zinc-300", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              ...
              " Cashback de 4,00 nfs por R$ 1,00 gasto junto a sellers credenciados (8,00 nfs por R$ 1,00 no Netfits Club);"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { src: "/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).pdf#toolbar=0", className: "w-full h-80 rounded-2xl border border-purple-500/30 bg-zinc-950", title: "PDF Oficial Netfits Regulamento" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 pt-1 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/docs/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).docx", download: "Regulamento Oficial, Termos e Condições de uso e Consentimento para o uso de dados (LGPD).docx", target: "_blank", rel: "noopener noreferrer", className: "py-2.5 px-4 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center gap-2 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-4 text-lime-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Baixar Regulamento e LGPD (.docx)" })
        ] }),
    ...
    showLgpdModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl bg-zinc-900 border border-lime-500/40 rounded-3xl p-6 shadow-2xl space-y-4 max-h-[90vh] flex flex-col text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-5 text-xs text-zinc-300 leading-relaxed pr-3 border-b border-zinc-800 pb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: 'NETFITS LTDA., pessoa jurídica de direito privado, inscrita no CNPJ/MF sob o nº 68.930.455/0001-40, com sede na Alameda das Embaúbas, 365, Quadra 06 Lote 19 sala 01, Alphaville, Santana de Parnaíba/SP, CEP 06.542-195, doravante denominada "Controladora".' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "dpo@netfits.com.br" }),
            " ou ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "contato@netfits.com.br" }),
            ".",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white mb-2 flex items-center gap-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Visualização do PDF Oficial com Marca d'Água:" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { src: "/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).pdf#toolbar=0", className: "w-full h-80 rounded-2xl border border-lime-500/30 bg-zinc-950", title: "PDF Oficial Netfits Termo LGPD" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 pt-1 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/docs/Regulamento%20Oficial,%20Termos%20e%20Condi%C3%A7%C3%B5es%20de%20uso%20e%20Consentimento%20para%20o%20uso%20de%20dados%20(LGPD).docx", download: "Regulamento Oficial, Termos e Condições de uso e Consentimento para o uso de dados (LGPD).docx", target: "_blank", rel: "noopener noreferrer", className: "py-2.5 px-4 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center gap-2 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-4 text-lime-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Baixar Termo LGPD e Regulamento (.docx)" })
        ] }),
