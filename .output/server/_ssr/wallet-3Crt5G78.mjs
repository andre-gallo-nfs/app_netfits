...
import { f as useWallet, u as useOperationalParams } from "./router-Cd-y_qDm.mjs";
import { n as netfitsMark } from "./netfits-mark-DN6CUhW7.mjs";
import "../_libs/sonner.mjs";
import { S as ShoppingBag, aD as ArrowDownLeft, a3 as ArrowUpRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 mt-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-purple-400 font-bold font-mono", children: "Validade 365 dias" })
      ] }),
