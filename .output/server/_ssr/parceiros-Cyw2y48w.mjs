...
import { k as trackPartnerRegistration, s as sharedSandboxStore } from "./router-CqfZuliV.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-BugLRRwT.mjs";
import "../_libs/sonner.mjs";
import { S as ShoppingBag, aw as Dumbbell, i as Users, ao as Apple, ax as HeartPulse, ay as Flame, az as Stethoscope, j as ShieldCheck, d as Sparkles, J as CircleCheck, h as Check, a4 as Search, an as CircleX, ak as CircleAlert, a9 as Mail, a8 as Phone, k as MapPin, aA as Instagram, e as Send, aB as Code, ag as Server, E as ExternalLink, Z as Zap, aC as Terminal } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "bg-zinc-900/90 border border-zinc-800 rounded-3xl p-5 md:p-8 space-y-6 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-6 border-t border-zinc-800/80 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Cashback de 4 nfs por R$ 1,00 gasto no e-commerce", "15% de Desconto em Suplementos e Vestuário", "1ª Sessão de Avaliação de Bioimpedância Grátis", "Isenção Total da Taxa de Matrícula", "Acúmulo de +25 nfs por treino ou consulta declarada", "20% de Desconto em Tratamentos de Recovery"].map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setFormData({
              ...formData,
