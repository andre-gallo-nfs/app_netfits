...
import { i as trackPartnerRegistration, s as sharedSandboxStore } from "./router-BFFZWipM.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-CkLajQKX.mjs";
import "../_libs/sonner.mjs";
import { ao as Dumbbell, ap as Flame, aq as HeartPulse, ag as Apple, ar as Stethoscope, d as Sparkles, j as ShieldCheck, h as Users, ac as CircleCheck, aj as Search, af as CircleX, a8 as CircleAlert, e as Send, M as MapPin } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-12 space-y-8 min-h-screen bg-zinc-950 text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "bg-zinc-900/90 border border-zinc-800 rounded-3xl p-6 space-y-6 shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-zinc-800 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-widest text-purple-400", children: "Passo 3 de 3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-extrabold text-white", children: "Proposta de Benefício para os Usuários" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400", children: "Defina o tipo de vantagem exclusiva oferecida à comunidade Netfits." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: formData.benefitType, onChange: (e) => setFormData({
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cashback_points", children: "Cashback em Pontos nfs para Usuários" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "discount_pct", children: "Desconto Percentual Exclusivo (ex: 10% a 20%)" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-bold text-zinc-300 mb-1", children: "Descrição dos Serviços e Diferenciais" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 3, placeholder: "Descreva brevemente os principais serviços do seu estabelecimento e a oferta de boas-vindas aos usuários Netfits...", value: formData.benefitDescription, onChange: (e) => setFormData({
            ...formData,
