...
import { b as nativeBridge, s as sharedSandboxStore, w as wallet } from "./router-_XrETBDk.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col justify-center px-4 py-8 max-w-md mx-auto font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center justify-center gap-3 px-6 py-3 bg-zinc-200 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded-2xl shadow-sm mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-12 bg-black p-1.5 rounded-2xl ring-2 ring-lime-400 shadow-md flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: netfitsMark, alt: "Símbolo Netfits", className: "size-9 object-contain drop-shadow-[0_0_10px_rgba(163,230,53,0.9)]" }) }),
