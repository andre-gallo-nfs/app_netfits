...
import { an as Dumbbell, ao as Flame, ap as HeartPulse, ae as Apple, aq as Stethoscope, c as Sparkles, h as ShieldCheck, U as Users, aa as CircleCheck, ah as Search, ad as CircleX, a5 as CircleAlert, d as Send, M as MapPin } from "../_libs/lucide-react.mjs";
...
function ParceirosRegistrationPage() {
  ...
  const handleVerifyDocument = () => {
    ...
    setValidationState({
      status: "validating",
      message: "Consultando base de dados da Receita Federal / Conselho..."
    });
    setTimeout(() => {
      if (docType === "cnpj") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-12 space-y-8", children: [
