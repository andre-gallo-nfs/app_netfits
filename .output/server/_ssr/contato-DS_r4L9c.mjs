...
import { a6 as Mail, M as MapPin, aa as CircleCheck, d as Send } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/80 px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/home", className: "flex items-center gap-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-extrabold tracking-tight text-xl text-white", children: [
          "Netfits ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-indigo-400 font-mono", children: "Contato" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-6 text-xs font-semibold text-zinc-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/home", className: "hover:text-white transition", children: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", className: "hover:text-purple-400 transition", children: "Admin" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/download", className: "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold text-xs px-4 py-2.5 rounded-full transition shadow-lg shadow-purple-600/30", children: "Abrir App →" })
    ] }) }),
