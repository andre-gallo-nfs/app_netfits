...
import { s as sharedSandboxStore, u as useOperationalParams, n as netfitsLogo, o as operationalParamsStore } from "./router-Bz8Xfi25.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-BrTDZy9l.mjs";
import { m as ChartColumn, n as FileText, a as Award, o as Coins, p as SlidersVertical, q as Rss, S as ShoppingBag, A as Activity, i as Users, r as Handshake, s as Cpu, D as DollarSign, t as ShieldAlert, T as TrendingUp, u as RefreshCw, v as Lock, w as Layers, C as ChevronDown, x as Clock, y as Download, Z as Zap, R as RotateCcw, z as MousePointerClick, I as Megaphone, l as Eye, J as Store, K as Tag, G as Gift, N as Truck, O as Star, Q as ShoppingCart, V as UserPlus, Y as Funnel, d as Sparkles, _ as Save, j as ShieldCheck, $ as Percent, a0 as UserCheck, e as Send, a1 as CircleCheck, g as Share2, a2 as Phone, a3 as Mail, a4 as ArrowUpRight, a5 as ArrowDownRight, a6 as ChevronLeft, a7 as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen max-w-full overflow-x-hidden bg-zinc-950 text-zinc-100 font-sans pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 bg-zinc-900 border-b border-zinc-800 px-4 py-3 flex items-center justify-between flex-wrap gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        }, className: "px-3 py-1.5 rounded-xl bg-zinc-800 hover:bg-red-950/60 hover:border-red-500/40 text-zinc-300 hover:text-red-300 border border-zinc-700 text-xs font-bold transition cursor-pointer flex items-center gap-1.5", title: "Encerrar Sessão Admin", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 p-5 rounded-2xl border border-cyan-500/40 space-y-3 md:col-span-2 lg:col-span-2 shadow-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-zinc-900 pb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-cyan-400/20 text-cyan-300 font-extrabold px-2.5 py-0.5 rounded-full border border-cyan-400/40", children: "Superado 🚀 (100% Dwell Time & High Conversion)" })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 pt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 block", children: "KR 5.1 Tempo de Sessão" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 block", children: "KR 5.2 Taxa Bounce Back" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 block", children: "KR 5.3 Tempo Últ. Acesso" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 block", children: "KR 5.4 Clique ➔ Vídeo 100%" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-3 rounded-xl border border-zinc-800 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase text-cyan-400 block", children: "KR 5.5 Visualização ➔ Compra" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 min-h-[380px]", children: [
        ...
        pitchSlide === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4 text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-4 rounded-2xl border border-rose-500/20 flex items-center gap-3.5", children: [
        ...
        pitchSlide === 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-2 flex flex-col justify-center min-h-[90px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-2 flex flex-col justify-center min-h-[90px]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Intermediação de Provas" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-950/40 p-4 rounded-2xl border border-purple-500/40 space-y-2 flex flex-col justify-center min-h-[90px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 p-4 rounded-2xl border border-zinc-800 flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=400&q=80", alt: "Academia e Treino", className: "size-14 rounded-xl object-cover shrink-0 border border-zinc-700" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Academias & Studios" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 p-4 rounded-2xl border border-zinc-800 flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=400&q=80", alt: "Nutrição e Suplementos", className: "size-14 rounded-xl object-cover shrink-0 border border-zinc-700" }),
        ...
        pitchSlide === 7 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/30 flex items-center gap-3.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/40 flex items-center gap-3.5 bg-lime-400/5", children: [
        ...
        pitchSlide === 8 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-2xl border border-zinc-800 text-center flex flex-col justify-center min-h-[110px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-lime-400/10 via-zinc-900 to-zinc-900 p-5 rounded-2xl border border-lime-400/40 text-center flex flex-col justify-center min-h-[110px]", children: [
        ...
        pitchSlide === 9 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-purple-300 text-xs", children: "1. Rede de Associados Netfits" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lime-400 text-xs", children: "2. Member-Get-Member (MGM)" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "3. Parcerias Corporativas & Provas" }) })
            ] })
          ] })
        ] }),
        pitchSlide === 10 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 flex items-center min-h-[60px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "1. Verticalização no Esporte Amador" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 flex items-center min-h-[60px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "2. Propriedade Intelectual FEFO" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 flex items-center min-h-[60px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "3. Lock-in B2B2C de Carteiras" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 flex items-center min-h-[60px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "4. Transição para Longevidade" }) })
          ] })
        ] }),
        ...
        pitchSlide === 12 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800 flex items-center min-h-[50px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block", children: "01. Usuário antes do ego" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800 flex items-center min-h-[50px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block", children: "02. Clareza antes da complexidade" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800 flex items-center min-h-[50px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block", children: "03. Evidência antes da convicção" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800 flex items-center min-h-[50px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block", children: "04. Velocidade com responsabilidade" }) })
            ] }),
