...
import { f as feedItems, u as useBadges, w as wallet } from "./router-D988PTjT.mjs";
import { P as ProductDetailSheet } from "./ProductDetailSheet-D71ysqyA.mjs";
import { n as netfitsMark } from "./netfits-mark-DN6CUhW7.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { B as Building2, c as Sparkles, b as ArrowRight, C as Check, P as Play, e as Share2, X, G as Gift, U as Users, f as Copy, A as Activity, g as Heart, h as ShieldCheck, L as Link2, M as MapPin, i as Bookmark, S as ShoppingBag } from "../_libs/lucide-react.mjs";
...
function FeedPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-4 mb-3 p-3 bg-purple-600/10 border border-purple-600/30 rounded-2xl flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-xl bg-purple-600 text-white grid place-items-center font-black text-xs shadow-sm", children: "nfs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "Recompensas de Engajamento" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Curtir (+5 nfs) · Salvar (+10 nfs) · Compartilhar (+10 nfs)" })
      ] })
    ] }) }),
