...
import { u as useBadges, s as sharedSandboxStore, w as wallet, a as useOperationalParams } from "./router-CDCQJJ8w.mjs";
import { P as ProductDetailSheet } from "./ProductDetailSheet-DMKjAXzN.mjs";
import { n as netfitsMark } from "./netfits-mark-DN6CUhW7.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { c as ArrowRight, h as Check, A as Activity, B as Building2, P as Play, g as Share2, X, d as Sparkles, G as Gift, i as Users, b as Copy, f as Heart, j as ShieldCheck, L as Link2, k as MapPin, l as Eye, m as Bookmark, S as ShoppingBag } from "../_libs/lucide-react.mjs";
...
function FeedPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-8 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CompactUtilityStrip, {}),
...
function WearableSurveyHero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-5 text-white shadow-sm space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mt-1 leading-relaxed", children: "Qual dispositivo você mais usa para registrar suas atividades físicas?" })
    ] }),
    !voted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleVote, className: "w-full bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs py-2.5 rounded-xl flex items-center justify-center gap-2 shadow-sm active:scale-98 transition-all cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Votar & Conectar Dispositivo (+10 nfs)" }),
...
function CompactUtilityStrip() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 border border-zinc-800 rounded-2xl p-3 flex items-center justify-between text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/levels", className: "flex items-center gap-2.5 text-zinc-300 hover:text-white transition group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-xl bg-purple-600/20 border border-purple-500/30 text-purple-400 grid place-items-center font-bold text-xs shrink-0 group-hover:bg-purple-600 group-hover:text-white transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "size-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold text-white leading-tight", children: "Badges & Selos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-zinc-400 font-mono", children: [
          unlockedCount,
          " de ",
          totalCount,
          " liberados"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 w-px bg-zinc-800" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/parceiros", className: "flex items-center gap-2.5 text-zinc-300 hover:text-white transition group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-xl bg-zinc-800 border border-zinc-700 text-zinc-300 grid place-items-center shrink-0 group-hover:bg-zinc-700 group-hover:text-white transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "size-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold text-white leading-tight", children: "Parceiros B2B" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-zinc-400", children: "Credenciamento" })
      ] })
    ] })
  ] }) });
}
