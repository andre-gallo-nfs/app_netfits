...
import { u as useAuth, n as nativeBridge, g as detectIdentifierType, v as validatePasswordRules, h as netfitsDarkLogo, b as authStore, p as passkeyService, s as sharedSandboxStore } from "./router-DIJZWtNc.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "./index.mjs";


import "../_libs/seroval.mjs";
import { a4 as UserPlus, ab as LogIn, aq as TriangleAlert, ar as CircleAlert, U as User, M as Mail, d as Sparkles, af as Phone, t as CreditCard, as as Calendar, G as Gift, a as Award, _ as CircleCheck, v as Lock, at as EyeOff, o as Eye, c as ShieldCheck, h as ArrowRight, ag as KeyRound, au as FingerprintPattern, av as CircleX } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white text-zinc-900 flex flex-col justify-center px-4 py-8 max-w-md mx-auto font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center justify-center gap-2.5 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: netfitsDarkLogo, alt: "Netfits", className: "h-10 w-auto object-contain shrink-0 rounded-lg shadow-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold tracking-tight text-3xl text-zinc-900", children: "Netfits" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-black text-zinc-900 tracking-tight", children: mode === "register" ? "Crie sua conta Netfits" : "Acesse sua conta" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-500 max-w-xs mx-auto", children: mode === "register" ? "Cadastre-se com seu E-mail, Celular ou CPF e receba +50 nfs bônus." : "Digite suas credenciais para continuar no aplicativo." })
    ] }),
    ...
    mode === "login" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLoginSubmit, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-1", children: [
        ...
        }, className: "w-full py-3 rounded-xl font-bold text-xs bg-zinc-900 dark:bg-zinc-800 text-white border border-purple-500/40 hover:bg-zinc-800 dark:hover:bg-zinc-700 transition-all flex items-center justify-center gap-2 active:scale-98 shadow-md cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FingerprintPattern, { className: "size-4 text-purple-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Entrar com Biometria / Passkey (Face ID / Touch ID)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-1 text-[10px] text-zinc-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-3" }),
            " FIDO2 / WebAuthn (Sem SMS OTP)"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-purple-600 dark:text-purple-400", children: [
            "Economia: ",
            passkeyService.getFinOpsMetrics().costSavedFormatted
          ] })
        ] })
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg bg-white text-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 space-y-4 max-h-[88vh] flex flex-col text-left", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3.5 pr-2 text-xs text-zinc-700 leading-relaxed border-b border-zinc-200 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50 p-3 rounded-2xl border border-purple-100 text-[11px] text-purple-900", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: "📌 Regulamento Oficial, Termos e Condições de Uso (Rev. 2.0):" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Este Regulamento rege a participação no Programa Netfits, o acúmulo de pontos nfs, estorno híbrido, validade FEFO e regras estritas de integridade e antifraude." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-zinc-900 text-sm", children: "1. Objeto do Programa" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "O Programa Netfits é um ecossistema digital de saúde (*healthspan*) e fidelidade operado pela ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Netfits Ltda." }),
        " (CNPJ/MF nº ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "68.930.455/0001-40" }),
        ", com sede na Alameda das Embaúbas, 365, Quadra 06 Lote 19 sala 01, Alphaville, Santana de Parnaíba-SP, CEP 06.542-195), destinado a incentivar treinos, consumo de conteúdo e compras no Marketplace com acúmulo de pontos ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "retenção visual contínua e foco de 100% da duração do vídeo" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-zinc-900 text-sm", children: "3. Direito Irrevogável de Exclusão Sumária & Perda de Saldo" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-zinc-900 text-sm", children: "4. Validade, Inatividade (360 dias) e Estorno Híbrido" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Os pontos ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "nfs" }),
        " possuem validade de 24 meses sob o sistema FEFO. Contas sem atividade por mais de 360 dias expiram de pleno direito. Em compras híbridas (pontos + cartão/Pix) canceladas no Marketplace, a devolução é realizada proporcionalmente na carteira e no gateway conforme o Art. 49 do CDC."
      ] })
    ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg bg-white text-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 space-y-4 max-h-[88vh] flex flex-col text-left", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-zinc-200 pb-3 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-extrabold text-zinc-900", children: "Consentimento para Uso de Dados (LGPD)" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3.5 pr-2 text-xs text-zinc-700 leading-relaxed border-b border-zinc-200 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-lime-50 p-3 rounded-2xl border border-lime-200 text-[11px] text-lime-950", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: "🔒 Tratamento Transparente & Proteção de Dados:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Seus dados cadastrais, transacionais e de telemetria esportiva são tratados com segurança e conformidade rigorosa com a LGPD pela Netfits Ltda." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-zinc-900 text-sm", children: "1. Bases Legais e Controladora" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "A ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Netfits Ltda." }),
        " atua como Controladora dos dados. O tratamento baseia-se em: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Execução de Contrato" }),
        " (Art. 7º, V) para gerenciamento de pontos e marketplace; ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Obrigação Legal" }),
        " (Art. 7º, II) para guarda de registros do Marco Civil da Internet; e ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Consentimento Específico" }),
        " (Art. 11, I) para dados de telemetria esportiva."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-zinc-900 text-sm", children: "2. Garantia de Não-Comercialização de Dados de Saúde" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "A Netfits compromete-se a ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "não vender, não repassar e não disponibilizar dados de frequência cardíaca, biometria ou telemetria esportiva para seguradoras de saúde ou planos médicos" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Você pode exercer seus direitos de confirmação, acesso, correção, anonimização, portabilidade ou revogação de consentimento contatando nosso Encarregado de Proteção de Dados (DPO) pelo e-mail ",
