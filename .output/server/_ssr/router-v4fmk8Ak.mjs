...
import { H as House, S as ShoppingBag, A as Activity, a as Award, W as Wallet, I as Infinity, X, b as ArrowRight, c as Sparkles, d as Send } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-CKzyk7Ee.css";
const netfitsLogo = "/assets/netfits-logo-DjUMognO.png";
const netfitsMark = "/assets/netfits-mark-D0RtFoJs.png";
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Infinity, { className: "size-6 text-lime-400 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 size-2.5 bg-lime-400 rounded-full ring-2 ring-purple-900" })
          ] }),
    ...
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-zinc-950 text-zinc-100 h-full flex flex-col shadow-2xl border-l border-zinc-800 animate-in slide-in-from-right duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-zinc-800 bg-zinc-900/90 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-full bg-gradient-to-br from-purple-600 to-lime-500 grid place-items-center shadow-inner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Infinity, { className: "size-5 text-zinc-950" }) }),
...
function TopBar() {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 bg-white text-zinc-900 border-b border-zinc-200 px-3 py-2.5 flex items-center justify-between shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-1.5 shrink-0", "aria-label": "netfits", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: netfitsMark,
...
const $$splitComponentImporter$8 = () => import("./index-kj1Nxl3w.mjs");
...
const $$splitComponentImporter$7 = () => import("./activities-BYVzm7wd.mjs");
...
const $$splitComponentImporter$6 = () => import("./admin-W7-W0yQO.mjs");
...
const $$splitComponentImporter$5 = () => import("./associado--2meElck.mjs");
...
const $$splitComponentImporter$4 = () => import("./auth-aQu90Uzs.mjs");
...
const $$splitComponentImporter$3 = () => import("./levels-_pCp9szF.mjs");
...
const $$splitComponentImporter$2 = () => import("./market-CPn_Fukb.mjs");
...
const $$splitComponentImporter$1 = () => import("./profile-BLby97IT.mjs");
...
const $$splitComponentImporter = () => import("./wallet-BS5DP5FF.mjs");
