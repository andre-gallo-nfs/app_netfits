...
import { s as sharedSandboxStore, u as useOperationalParams, n as netfitsLogo, o as operationalParamsStore } from "./router-K71vNqap.mjs";
import { I as InstitutionalWebHeader } from "./InstitutionalWebHeader-C8Zu6TK_.mjs";
import { m as ChartColumn, n as FileText, a as Award, o as Coins, p as SlidersVertical, q as Rss, S as ShoppingBag, A as Activity, i as Users, r as Handshake, s as Cpu, D as DollarSign, t as ShieldAlert, T as TrendingUp, u as RefreshCw, v as Layers, C as ChevronDown, w as Clock, x as Download, Z as Zap, y as Megaphone, z as MousePointerClick, l as Eye, I as Store, J as Tag, G as Gift, K as Truck, N as Star, O as ShoppingCart, Q as UserPlus, V as Funnel, R as RotateCcw, d as Sparkles, Y as Save, j as ShieldCheck, _ as Percent, $ as UserCheck, e as Send, a0 as CircleCheck, g as Share2, a1 as Phone, a2 as Mail, a3 as ArrowUpRight, a4 as ArrowDownRight, a5 as ChevronLeft, a6 as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen max-w-full overflow-x-hidden bg-zinc-950 text-zinc-100 font-sans pb-12", children: [
    ...
    showPitchDeckModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 border border-purple-500/30 rounded-3xl w-full max-w-5xl lg:max-w-6xl max-h-[92vh] overflow-y-auto p-6 md:p-8 space-y-6 shadow-2xl flex flex-col justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-zinc-800 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-2xl bg-purple-600/20 border border-purple-500/40 grid place-items-center text-lime-400 font-black text-lg", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-lime-400", children: "Executive Pitch Deck — Rodada Seed / Series A" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xl font-black text-white flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Netfits Ltda." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] bg-purple-500/20 text-purple-300 border border-purple-500/30 px-3 py-0.5 rounded-full font-mono font-bold", children: [
                "Slide ",
                pitchSlide,
                " de 12"
              ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 overflow-x-auto no-scrollbar scrollbar-none pb-2 border-b border-zinc-800/80", children: ["1. Capa", "2. Problema", "3. Solução", "4. Mercado TAM", "5. Monetização", "6. Programa nfs", "7. Aquisição & Influenciadores", "8. Unit Economics", "9. Canais B2B2C", "10. Moat Tech", "11. Captação & Alocação", "12. Visão & Valores"].map((name, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPitchSlide(idx + 1), className: `px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition cursor-pointer ${pitchSlide === idx + 1 ? "bg-gradient-to-r from-purple-600 to-purple-800 text-white font-black shadow-md shadow-purple-600/30 border border-purple-400/40" : "bg-zinc-900/80 text-zinc-400 hover:bg-zinc-800 hover:text-zinc-200 border border-zinc-800"}`, children: name }, idx)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 min-h-[380px]", children: [
        pitchSlide === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-5 text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-zinc-300 font-medium leading-relaxed max-w-lg", children: "O ecossistema digital de recompensas, engajamento e saúde que conecta o atleta amador às melhores marcas, academias e profissionais de longevidade do Brasil." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex items-center gap-3 flex-wrap text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 px-3.5 py-2 rounded-xl text-zinc-300 font-bold flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-black", children: "01" }),
                " Benefícios Imediatos"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 px-3.5 py-2 rounded-xl text-zinc-300 font-bold flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-black", children: "02" }),
                " Hábitos Recorrentes"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-800 px-3.5 py-2 rounded-xl text-zinc-300 font-bold flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-black", children: "03" }),
                " Longevidade Ativa"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl overflow-hidden border border-purple-500/30 shadow-2xl group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1517649763962-0c623266010b?auto=format&fit=crop&w=800&q=80", alt: "Esportista Amador Netfits", className: "w-full h-80 object-cover group-hover:scale-105 transition duration-500" }),
        ...
        pitchSlide === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-rose-500/30 shadow-2xl relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/20 to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-rose-500/20 border border-rose-500/40 text-rose-300 text-xs font-bold px-3 py-1 rounded-full", children: "⚠️ Fricção no Mercado de Fitness & Saúde" }) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4 text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-rose-400 font-bold uppercase tracking-wider", children: "The Problem" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-1", children: "Gargalos Críticos do Consumidor & Mercado" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-4 rounded-2xl border border-rose-500/20 flex items-start gap-3.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-400 font-black text-sm grid place-items-center shrink-0", children: "65%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Churn Elevado em 90 Dias" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Mais de 65% dos praticantes abandonam academias ou apps pela ausência de recompensas diárias tangíveis." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-4 rounded-2xl border border-rose-500/20 flex items-start gap-3.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-400 font-black text-sm grid place-items-center shrink-0", children: "CAC" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Custo de Aquisição Explosivo" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Marcas esportivas e clínicas dependem de anúncios pagos caros com conversões cada vez menores." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/90 p-4 rounded-2xl border border-rose-500/20 flex items-start gap-3.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-400 font-black text-sm grid place-items-center shrink-0", children: "0%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Programas de Pontos Desconectados" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Sistemas legados expiram pontos sem transparência e impõem regras punitivas ao usuário." })
                ] })
              ] })
            ] })
          ] })
        ...
        pitchSlide === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4 text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "The Solution" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-1", children: "SuperApp Integrado & Motor de Fidelização" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/30 space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 text-base", children: "📱" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "SuperApp 4 em 1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "GPS de treino, Feed Social remunerado, Marketplace e Clube de Benefícios num único app." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/30 space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 text-base", children: "⌚" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Wearables Ingest" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "Sincronização nativa com Garmin, Apple Watch e Strava para conversão de treinos em nfs." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/30 space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 text-base", children: "🛒" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Shop com Resgate Real" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "Desconto imediato em suplementos, vestuário, exames e consultas de nutrição." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/30 space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 text-base", children: "🛡️" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Algoritmo FEFO Protegido" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "First-Expiring, First-Out: resgate inteligente que consome priorizadamente o ponto prestes a vencer." })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-lime-400/30 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1508685096489-7aacd43bd3b1?auto=format&fit=crop&w=800&q=80", alt: "Wearable e App Netfits", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-lime-400/20 border border-lime-400/40 text-lime-300 text-xs font-bold px-3 py-1 rounded-full", children: "⚡ Conexão Nativa com Smartwatches" }) })
          ] }) })
        ] }),
        pitchSlide === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Mercado Potencial & Metas de Expansão" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-purple-500/20 text-purple-300 border border-purple-500/30 px-3 py-1 rounded-full text-xs font-bold font-mono", children: "Brasil · América Latina" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-2xl border border-zinc-800 flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-zinc-400 uppercase tracking-wider font-bold", children: "TAM · Mercado Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl font-black text-white mt-2", children: "R$ 85 Bilhões" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mt-2", children: "Gasto anual em academias, nutrição, exames e acessórios esportivos no Brasil." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-3 border-t border-zinc-800 text-[10px] text-zinc-500 font-mono", children: "Fonte: IHRSA & Abiad" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-2xl border border-purple-500/30 flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-purple-400 uppercase tracking-wider font-bold", children: "SAM · Mercado Endereçável" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl font-black text-purple-300 mt-2", children: "R$ 18 Bilhões" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mt-2", children: "14 Milhões de praticantes de corrida e fitness que utilizam smartwatches ou apps." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-3 border-t border-zinc-800 text-[10px] text-purple-400 font-mono", children: "Público Ativo Digital" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-purple-950/50 via-zinc-900 to-zinc-900 p-5 rounded-2xl border border-lime-400/40 flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-lime-400 uppercase tracking-wider font-bold", children: "SOM · Meta 3 Anos" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl font-black text-lime-300 mt-2", children: "1M Usuários" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-300 mt-2", children: "Atletas amadores transacionando ativamente no ecossistema Netfits." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-3 border-t border-lime-400/20 text-[10px] text-lime-400 font-mono font-bold", children: "★ Meta Executiva 36 Meses" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl overflow-hidden border border-zinc-800 h-28 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1486218119243-13883505764c?auto=format&fit=crop&w=1200&q=80", alt: "Atletas em Maratona", className: "w-full h-full object-cover opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-zinc-950 via-zinc-950/70 to-transparent p-4 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-200 max-w-2xl font-medium", children: '"O mercado de corrida e hábitos saudáveis no Brasil cresce a duplo dígito ao ano, impulsionado pela busca por longevidade ativa e prevenção médica."' }) })
          ] })
        ] }),
        pitchSlide === 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Monetização Multirreceptora" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-black", children: "01 · MARKETPLACE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Comissão de Sellers" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "Take-rate cobrado sobre o GMV de suplementos, vestuário e serviços credenciados." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-black", children: "02 · MÍDIA FEED" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Mídia Patrocinada" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "Anúncios no feed e pesquisas interativas por marcas parceiras de longevidade." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-black", children: "03 · EVENTOS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Intermediação" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400", children: "Taxa de conveniência em inscrições de corridas de rua e provas parceiras." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-950/40 p-4 rounded-2xl border border-purple-500/40 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-purple-300 font-black", children: "04 · NETFITS CLUB" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Assinatura Recorrente" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-purple-200 font-medium", children: "Clube de benefícios exclusivos com multiplicadores de pontos para atletas dedicados." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 p-4 rounded-2xl border border-zinc-800 flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=400&q=80", alt: "Academia e Treino", className: "size-16 rounded-xl object-cover shrink-0 border border-zinc-700" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Academias & Studios" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Credenciamento zero taxa de adesão; atração de novos alunos via pontos netfits." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900/80 p-4 rounded-2xl border border-zinc-800 flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=400&q=80", alt: "Nutrição e Suplementos", className: "size-16 rounded-xl object-cover shrink-0 border border-zinc-700" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Sellers de Nutrição & Wearables" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Venda direta com resgate integrado e conversão acima da média do e-commerce." })
              ] })
            ] })
          ] })
        ] }),
        pitchSlide === 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-purple-300 font-bold uppercase tracking-wider", children: "Tokenomics & Solvency" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Engenharia do Programa de Pontos (nfs)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/30 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-zinc-800 pb-2 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 font-medium", children: "Acúmulo Base por Esporte:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-lime-400 font-bold", children: "Incentivo Diário Tangível" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-zinc-800 pb-2 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 font-medium", children: "Custo de Resgate (Shop):" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-lime-300 font-bold", children: "Totalmente Subsidiado por Sellers" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-zinc-800 pb-2 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 font-medium", children: "Provisão Automática em Caixa:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-purple-300 font-bold", children: "100% Protegido" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-300 font-bold", children: "Gestão de Breakage:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-white font-black", children: "Previsibilidade Atuarial" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-lime-400/10 border border-lime-400/30 p-3.5 rounded-2xl flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-lime-300", children: "Garantia de Solvência de Caixa:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-black text-lime-300 text-sm", children: "Passivo 100% Provisionado" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-3xl border border-zinc-800 space-y-4 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-14 rounded-2xl bg-purple-600/20 border border-purple-500/40 text-purple-300 grid place-items-center mx-auto text-2xl", children: "⚖️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base font-extrabold text-white", children: "Algoritmo FEFO Protegido" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 mt-1", children: "First-Expiring, First-Out: garante a maior taxa de resgate e satisfação do cliente, com segurança atuarial." })
            ] })
          ] }) })
        ] }),
        pitchSlide === 7 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-lime-400/40 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=800&q=80", alt: "Influenciador e Treinador Esportivo Associado", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/20 to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-lime-400/20 border border-lime-400/40 text-lime-300 text-xs font-bold px-3 py-1 rounded-full", children: "🚀 Motor de Tração Exponencial" }) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "Acquisition Flywheel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Alavancagem via Influenciadores (Associados)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/30 flex items-start gap-3.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-purple-600/20 border border-purple-500/40 text-lime-400 font-black text-sm grid place-items-center shrink-0", children: "01" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Creators & Treinadores como Associados" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Influenciadores esportivos, médicos de performance e coaches ganham canal próprio e atração acelerada de sua comunidade." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/30 flex items-start gap-3.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-purple-600/20 border border-purple-500/40 text-lime-400 font-black text-sm grid place-items-center shrink-0", children: "02" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "Efeito de Rede Vitalício (Carteira Atribuída)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-0.5", children: "Cada seguidor que entra pelo código do influenciador fica vinculado permanentemente, gerando engajamento e recorrência contínua." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/40 flex items-start gap-3.5 bg-lime-400/5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-lime-400/20 border border-lime-400/40 text-lime-300 font-black text-sm grid place-items-center shrink-0", children: "03" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lime-300 text-xs", children: "Amplificação Viral Member-Get-Member" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-300 mt-0.5", children: "Os seguidores convertidos passam a indicar seus parceiros de treino, criando um Coeficiente Viral K > 1 com CAC residual nulo." })
                ] })
              ] })
            ] })
          ] })
        ] }),
        pitchSlide === 8 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Eficiência de Capital Excepcional" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-2xl border border-zinc-800 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-zinc-400 uppercase font-bold", children: "CAC Orgânico / B2B2C" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-black text-lime-400 mt-2", children: "Ultra Baixo" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-2", children: "Aquisição puxada pela rede de Associados e pela indicação de amigos (MGM)." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-5 rounded-2xl border border-zinc-800 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-purple-400 uppercase font-bold", children: "LTV Recorrente" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-black text-purple-300 mt-2", children: "Alto Valor" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-zinc-400 mt-2", children: "Recorrência do Netfits Club + marketplace e serviços esportivos." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-lime-400/10 via-zinc-900 to-zinc-900 p-5 rounded-2xl border border-lime-400/40 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-lime-400 uppercase font-bold", children: "Relação LTV / CAC" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-black text-lime-300 mt-2", children: "Alta Eficiência" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-lime-400 font-bold mt-2", children: "Payback Acelerado por Usuário" })
            ] })
          ] })
        ] }),
        pitchSlide === 9 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-purple-500/30 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=800&q=80", alt: "Associado Netfits Médico e Nutricionista", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-purple-500/20 border border-purple-500/40 text-purple-300 text-xs font-bold px-3 py-1 rounded-full", children: "🩺 Rede de Associados Credenciados" }) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "Distribution Channels" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Canais B2B2C & Efeito Viral MGM" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-purple-300 text-xs", children: "1. Rede de Associados Netfits" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 mt-1", children: "Médicos esportivos, nutricionistas e personal trainers atuam como embaixadores com comissão vitalícia." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lime-400 text-xs", children: "2. Member-Get-Member (MGM)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 mt-1", children: "Bônus instantâneo de pontos no cadastro de amigo + incentivo adicional no primeiro resgate." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "3. Parcerias Corporativas & Provas" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 mt-1", children: "Integração com organizadores de corridas e academias para onboarding em massa de atletas." })
              ] })
            ] })
          ] })
        ] }),
        pitchSlide === 10 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Moat Competitivo & Barreiras de Entrada" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "1. Verticalização no Esporte Amador" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Foco exclusivo na rotina do esportista amador, criando uma comunidade altamente engajada e de nicho valioso." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "2. Propriedade Intelectual FEFO" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Motor atuarial protegido para gestão de passivos e expiração de pontos sem risco para o caixa." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "3. Lock-in B2B2C de Carteiras" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Vínculo direto entre o atleta e seu profissional de saúde cria forte barreira de saída da plataforma." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/20 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-white text-xs", children: "4. Transição para Longevidade" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Acompanhamento contínuo da jornada de hábitos do usuário ao longo de décadas." })
            ] })
          ] })
        ] }),
        pitchSlide === 11 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "Use of Funds" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Alocação de Recursos (Rodada Seed)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-lime-400/10 text-lime-300 border border-lime-400/30 px-3 py-1 rounded-full text-xs font-bold font-mono", children: "Rodada Seed / Expansão" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "🛠️ Produto & Tecnologia Native-Shell" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-mono", children: "40%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-900 h-2.5 rounded-full overflow-hidden border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-lime-400 h-full rounded-full w-[40%]" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "🚀 Aquisição, Growth & Comunidade" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-400 font-mono", children: "25%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-900 h-2.5 rounded-full overflow-hidden border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-purple-500 h-full rounded-full w-[25%]" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "🤝 Expansão de Parcerias & Associados" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 font-mono", children: "15%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-900 h-2.5 rounded-full overflow-hidden border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-500 h-full rounded-full w-[15%]" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "📊 BI, Wearables & Antifraude" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400 font-mono", children: "10%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-900 h-2.5 rounded-full overflow-hidden border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-emerald-400 h-full rounded-full w-[10%]" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "⚖️ Operações & Governança Jurídica" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 font-mono", children: "10%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-zinc-900 h-2.5 rounded-full overflow-hidden border border-zinc-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-600 h-full rounded-full w-[10%]" }) })
            ] })
          ] })
        ] }),
        pitchSlide === 12 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-lime-400/40 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?auto=format&fit=crop&w=800&q=80", alt: "Atleta ao Chegar na Linha de Chegada", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-lime-400/20 border border-lime-400/40 text-lime-300 text-xs font-bold px-3 py-1 rounded-full", children: "🏁 Paixão pelo Movimento Ativo" }) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "Company Culture" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "O Código Netfits (Nossos Valores)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block mb-1", children: "01. Usuário antes do ego" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-[11px]", children: "Tudo o que construímos busca gerar valor tangível ao esportista amador." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block mb-1", children: "02. Clareza antes da complexidade" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-[11px]", children: "Experiências simples, transparentes e sem letras miúdas em pontos." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block mb-1", children: "03. Evidência antes da convicção" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-[11px]", children: "Decisões pautadas em dados empíricos de uso e métricas esportivas." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-xl border border-zinc-800", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold block mb-1", children: "04. Velocidade com responsabilidade" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-[11px]", children: "Execução ágil mantendo rigor financeiro e solidez de caixa." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 text-center md:text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-lime-400 font-mono font-bold", children: "Netfits Ltda. — diretoria@netfits.com.br — www.netfits.com.br" }) })
          ] })
        ] })
      ] }),
