...
import { H as House, S as ShoppingBag, A as Activity, a as Award, W as Wallet, F as FlaskConical, C as ChevronDown, E as ExternalLink, b as Copy, R as RotateCcw, X, c as ArrowRight, d as Sparkles, e as Send } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-CZvj1qY9.css";
...
function AppShell({ children }) {
  ...
  if (path === "/admin" || path.startsWith("/associado") || path === "/home" || path === "/faq" || path === "/contato" || path === "/parceiros" || path === "/download") {
...
function HomologationControlPanel() {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const [activeTab, setActiveTab] = reactExports.useState("flows");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-4 right-4 z-50 font-sans", children: [
    ...
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[380px] max-w-[calc(100vw-32px)] bg-zinc-950 text-white border border-purple-500/40 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in slide-in-from-bottom-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-900 via-purple-950 to-zinc-950 p-4 border-b border-purple-500/20 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-black uppercase tracking-wider text-white", children: "Suíte de Homologação & Testes" }),
...
const $$splitComponentImporter$d = () => import("./index-dm8OdxTY.mjs");
...
const $$splitComponentImporter$c = () => import("./activities-BksonUQv.mjs");
...
const $$splitComponentImporter$b = () => import("./admin-CnWZIUJm.mjs");
...
const $$splitComponentImporter$a = () => import("./associado-BbezRSTK.mjs");
...
const $$splitComponentImporter$9 = () => import("./auth-CWfxazgd.mjs");
...
const $$splitComponentImporter$8 = () => import("./contato-C4HtBq_8.mjs");
...
const $$splitComponentImporter$7 = () => import("./download-CBqfZWHn.mjs");
...
const $$splitComponentImporter$6 = () => import("./faq-DhR8kqIb.mjs");
...
const $$splitComponentImporter$5 = () => import("./home-ClfW3A9Z.mjs");
...
const $$splitComponentImporter$4 = () => import("./levels-DI0fEq5Q.mjs");
...
const $$splitComponentImporter$3 = () => import("./market-BLoPzXjR.mjs");
...
const $$splitComponentImporter$2 = () => import("./parceiros-D8m73g_r.mjs");
...
const $$splitComponentImporter$1 = () => import("./profile-DBKtjEKl.mjs");
...
const $$splitComponentImporter = () => import("./wallet-K3l5DMxR.mjs");
...
export {
  ...
  netfitsDarkLogo as d,
  badgesStore as e,
  feedItems as f,
  marketCategories as g,
  useWallet as h,
  trackPartnerRegistration as i,
  profileAvatar as j,
  marketProducts as m,
  netfitsLogo as n,
  parseNfs as p,
