...
import { b as nativeBridge, s as sharedSandboxStore, w as wallet } from "./router-BtcgN9KE.mjs";
import { V as UserPlus, a9 as LogIn, ab as TriangleAlert, ac as CircleAlert, U as User, a3 as Mail, d as Sparkles, a2 as Phone, ad as CreditCard, ae as Calendar, G as Gift, a as Award, a1 as CircleCheck, a8 as Lock, af as EyeOff, l as Eye, j as ShieldCheck, c as ArrowRight, ag as KeyRound, ah as CircleX } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col justify-center px-4 py-8 max-w-md mx-auto font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center justify-center gap-3 px-6 py-3 bg-zinc-200 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded-2xl shadow-sm mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black p-2 rounded-xl ring-2 ring-lime-400/80 shadow-md flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: netfitsMark, alt: "Símbolo Netfits", className: "size-7 object-contain drop-shadow-[0_0_8px_rgba(163,230,53,0.8)]" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black text-black tracking-tight font-sans", children: "netfits" })
      ] }),
