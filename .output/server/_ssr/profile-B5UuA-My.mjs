...
import { s as sharedSandboxStore, w as wallet } from "./router-tKdzCQyA.mjs";
import "./index.mjs";


import "../_libs/seroval.mjs";
import { aH as ArrowLeft, U as User, ac as LogIn, aI as Camera, a4 as UserPlus, aJ as Sprout, d as Sparkles, b as Copy, l as Share2, g as Users, as as Calendar, ag as Phone, M as Mail, n as MapPin, A as Activity, k as Check, aK as Plus, m as Heart, aC as Dumbbell, aL as Watch, a7 as Save, X, aM as Upload, ad as Trash2, a as Award, L as Link2, t as CreditCard, aN as CircleCheckBig, al as ChevronRight } from "../_libs/lucide-react.mjs";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border space-y-2.5 bg-purple-600/5 dark:bg-purple-950/20 p-3 rounded-2xl border border-purple-500/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-lime-600 dark:text-lime-400 bg-lime-500/10 px-2 py-0.5 rounded-full border border-lime-500/20", children: "+50 nfs + 5% comissão" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground leading-relaxed", children: [
              ...
              " pré-preenchido automaticamente! Você ganha +50 nfs no cadastro dele e ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "5% de comissão recorrente" }),
