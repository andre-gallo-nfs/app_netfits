...
import { s as sharedSandboxStore, w as wallet } from "./router-OtdzUaKH.mjs";
import "./index.mjs";


import "../_libs/seroval.mjs";
import { aH as ArrowLeft, U as User, ab as LogIn, aI as Camera, a4 as UserPlus, aJ as Sprout, d as Sparkles, b as Copy, l as Share2, g as Users, as as Calendar, af as Phone, M as Mail, n as MapPin, A as Activity, k as Check, aK as Plus, m as Heart, aC as Dumbbell, aL as Watch, a7 as Save, X, aM as Upload, ac as Trash2, a as Award, L as Link2, t as CreditCard, aN as CircleCheckBig, ak as ChevronRight } from "../_libs/lucide-react.mjs";
...
function ProfilePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background pb-28 font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-foreground text-background px-4 pt-6 pb-16 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/feed", className: "size-9 rounded-full bg-background/10 hover:bg-background/20 grid place-items-center transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "size-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border space-y-2.5 bg-purple-600/5 dark:bg-purple-950/20 p-3 rounded-2xl border border-purple-500/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-lime-600 dark:text-lime-400 bg-lime-500/10 px-2 py-0.5 rounded-full border border-lime-500/20", children: "+50 nfs por indicação | 10% no Shop (Clube)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground leading-relaxed", children: [
              ...
              " pré-preenchido automaticamente! Você ganha ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "+50 nfs" }),
              " no cadastro dele (premiação única com marcação permanente). Assinantes do ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Netfits Club" }),
              " turbinam a regra para ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "10% de comissão em pontos" }),
              " sobre todas as compras dos indicados no Shop!"
            ] }),
...
function Card({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-card rounded-2xl ring-1 ring-black/5 p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-7 rounded-lg bg-muted grid place-items-center", children: Icon && typeof Icon === "function" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-3.5 text-foreground/70" }) : null }),
