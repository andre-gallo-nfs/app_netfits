...
import { f as useWallet, p as parseNfs, w as wallet, s as sharedSandboxStore$1 } from "./router-Ckirwgm2.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { X, f as Heart, O as Star, aq as BadgeCheck, N as Truck, R as RotateCcw, h as Check, j as ShieldCheck, Z as Zap, S as ShoppingBag, E as ExternalLink, K as Tag, d as Sparkles, ad as CreditCard, ar as QrCode, v as Lock } from "../_libs/lucide-react.mjs";
const NFS_RATE = 0.02;
...
function ProductCheckoutSheet({
  ...
  function handleConfirm() {
    if (nfsToUse > 0) {
      ...
      sharedSandboxStore$1.buyShopProduct(product.title, nfsToUse);
    } else {
      sharedSandboxStore$1.buyShopProduct(product.title, Math.ceil(priceNum / NFS_RATE));
    }
    if (cashbackNfs > 0) {
