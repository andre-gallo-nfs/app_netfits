...
import { ak as Search, al as CircleQuestionMark, am as ChevronUp, C as ChevronDown, a2 as Mail } from "../_libs/lucide-react.mjs";
...
const FAQ_ITEMS = [{
  ...
  answer: "Os pontos nfs são a moeda de fidelidade do ecossistema Netfits. Cada ponto emitido é provisionado com 100% de solvência atuarial em caixa (R$ 0,01 por nfs). Os pontos possuem validade de 24 meses, garantindo total transparência e segurança em seus resgates."
}, {
  id: "faq_2",
  category: "shop",
