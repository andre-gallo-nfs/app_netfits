...
import { s as sharedSandboxStore$1, w as wallet } from "./router-DlS3uTb_.mjs";
import { aB as ArrowLeft, U as User, a3 as LogIn, aC as Camera, V as UserPlus, aD as Sprout, d as Sparkles, b as Copy, g as Share2, i as Users, af as Calendar, a5 as Phone, a6 as Mail, k as MapPin, A as Activity, h as Check, aE as Plus, f as Heart, at as Dumbbell, aF as Watch, _ as Save, X, aG as Upload, a4 as Trash2, a as Award, L as Link2, ae as CreditCard, aH as CircleCheckBig, aa as ChevronRight } from "../_libs/lucide-react.mjs";
...
function ProfilePage() {
  const [activeUser, setActiveUser] = reactExports.useState(sharedSandboxStore$1.getActiveUser());
  ...
  reactExports.useEffect(() => {
    const unsubscribe = sharedSandboxStore$1.subscribe(() => {
      setActiveUser(sharedSandboxStore$1.getActiveUser());
    });
    return () => {
      unsubscribe();
    };
  ...
  const handleFileUpload = (e) => {
    ...
    reader.onload = (event) => {
      ...
      if (base64Url) {
        sharedSandboxStore$1.updateUser(activeUser.id, {
          avatarUrl: base64Url
        });
