...
import { s as sharedSandboxStore$1, u as useOperationalParams, n as netfitsLogo, A as ALL_KR_MAP, o as operationalParamsStore } from "./router-D80uSuGu.mjs";
    ...
    showPitchDeckModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 border border-purple-500/30 rounded-3xl w-full max-w-5xl lg:max-w-6xl max-h-[92vh] overflow-y-auto p-6 md:p-8 space-y-6 shadow-2xl flex flex-col justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 min-h-[380px]", children: [
        ...
        pitchSlide === 9 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold uppercase tracking-wider", children: "Defensability" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Moat Tecnológico & Squad de 8 Agentes IA" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-2xl border border-lime-400/30 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lime-400 text-xs", children: "Squad de 8 Agentes IA" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Shop, Feed, Fraud Shield, Tax Audit, CS 24/7, Partner, Sensor AI, BI Miner." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-2xl border border-emerald-400/30 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-emerald-300 text-xs", children: "FinOps IA (-95,2%)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "R$ 990/mês (US$ 180) vs R$ 20.900/mês monolítico via Gemini Flash/Lite." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-2xl border border-purple-500/30 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-purple-300 text-xs", children: "Algoritmo FEFO" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Solvência garantida da moeda nfs (1 nfs = R$ 0,02) e prevenção a spoofing." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-3.5 rounded-2xl border border-lime-400/30 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lime-400 text-xs", children: "Lock-in B2B2C" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400", children: "Integração profunda com médicos, nutricionistas, academias e marcas." })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-lime-400/30 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=800&q=80", alt: "Servidores e Inteligencia de Dados", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-lime-400/20 border border-lime-400/40 text-lime-300 text-xs font-bold px-3 py-1 rounded-full", children: "Arquitetura Multiagêntica de IA" }) })
          ] }) })
        ] }),
        pitchSlide === 10 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-center text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-purple-400 font-bold uppercase tracking-wider", children: "Leadership & Execution" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-0.5", children: "Time de Fundadores — Por Que Nós?" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-lime-400/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime-400 font-bold font-mono", children: "André Gallo · CEO & Fundador" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-300 mt-1 font-medium", children: "Gestor de Produtos & Especialista em Loyalty, Fidelização de Clientes e Estratégia de Negócios. Liderança em ecossistemas de engajamento." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-purple-500/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-300 font-bold font-mono", children: "Diretoria de Operações & Growth" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-300 mt-1", children: "Experiência comprovada em expansão de e-commerce, ecossistemas fitness e relacionamento com redes de academias." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 p-4 rounded-2xl border border-emerald-400/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-300 font-bold font-mono", children: "Conselho Consultivo de Saúde" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-300 mt-1", children: "Médicos do esporte e nutricionistas VIP com conexão direta à rede de Associados prescritores." })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-purple-500/30 shadow-2xl relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80", alt: "Reuniao Executiva dos Fundadores", className: "w-full h-80 object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent flex items-end p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-purple-500/20 border border-purple-500/40 text-purple-300 text-xs font-bold px-3 py-1 rounded-full", children: "Experiência em Produto & Loyalty" }) })
          ] }) })
        ] }),
