...
import { n as netfitsMark, b as netfitsLogo, c as nativeBridge, w as wallet } from "./router-v4fmk8Ak.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { a0 as UserPlus, a1 as LogIn, a2 as TriangleAlert, a3 as CircleAlert, a4 as Mail, a5 as CreditCard, a6 as Phone, a7 as User, G as Gift, a as Award, a8 as CircleCheck, _ as Lock, a9 as EyeOff, E as Eye, h as ShieldCheck, c as Sparkles, b as ArrowRight, aa as KeyRound, ab as CircleX } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col justify-center px-4 py-8 max-w-md mx-auto font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center justify-center gap-2 p-2 bg-foreground rounded-2xl shadow-lg mb-2", children: [
    ...
    mode === "register" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleRegisterSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-xs font-bold text-foreground flex justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Usuário (E-mail, Celular ou CPF) *" }),
          identifierType !== "unknown" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-purple-600 uppercase tracking-wider", children: [
            "Tipo: ",
            identifierType === "email" ? "E-mail" : identifierType === "cpf" ? "CPF" : "Celular"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-muted-foreground", children: identifierType === "email" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-4 text-purple-600" }) : identifierType === "cpf" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: "size-4 text-purple-600" }) : identifierType === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4 text-purple-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "size-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: identifier, onChange: (e) => {
            setIdentifier(e.target.value);
            setDuplicateAlert(null);
            setFormError(null);
          }, placeholder: "Ex: usuario@email.com, (11) 98765-4321 ou 123.456.789-00", className: "w-full bg-card border border-border rounded-xl pl-10 pr-4 py-3 text-xs font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-purple-600", required: true })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-foreground", children: "Nome Completo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: fullName, onChange: (e) => setFullName(e.target.value), placeholder: "Digite seu nome completo", className: "w-full bg-card border border-border rounded-xl px-4 py-3 text-xs font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-purple-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      password.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-3 space-y-2 text-[11px]", children: [
        (() => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 pb-1 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-[10px] font-extrabold uppercase", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Força da Senha:" }),
    ...
    mode === "login" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLoginSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: identifier, onChange: (e) => setIdentifier(e.target.value), placeholder: "Seu e-mail, celular ou CPF", className: "w-full bg-card border border-border rounded-xl pl-10 pr-4 py-3 text-xs font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-purple-600", required: true })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted p-3 rounded-xl border border-border space-y-1 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold text-foreground", children: "Credenciais de Teste:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground font-mono", children: [
          "Usuário: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "atleta@netfits.com.br" }),
          " | Senha: ",
...
function TermsOfServiceModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg bg-white text-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 space-y-4 max-h-[88vh] flex flex-col text-left", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3.5 pr-2 text-xs text-zinc-700 leading-relaxed border-b border-zinc-200 pb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "O Programa Netfits é um ecossistema digital de recompensas operado pela Netfits Tecnologia S.A., destinado a incentivar a prática regular de atividades físicas, a nutrição saudável e hábitos de longevidade." }),
...
function LgpdPrivacyModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg bg-white text-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 space-y-4 max-h-[88vh] flex flex-col text-left", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3.5 pr-2 text-xs text-zinc-700 leading-relaxed border-b border-zinc-200 pb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "A ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Netfits Tecnologia S.A." }),
