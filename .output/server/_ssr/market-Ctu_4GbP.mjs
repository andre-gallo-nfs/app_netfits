...
import { u as useWallet, a as useOperationalParams, s as sharedSandboxStore, e as nativeBridge } from "./router-DqMg3Qre.mjs";
import { Z as Zap, I as RefreshCw, E as ExternalLink, j as ShieldCheck, ak as CircleAlert } from "../_libs/lucide-react.mjs";
...
function MarketEmbeddedPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full w-full bg-zinc-950 select-none overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border-b border-zinc-800 px-3 py-2 flex items-center justify-between gap-2 shrink-0 z-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 rounded-lg bg-purple-600/20 border border-purple-500/30 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "size-3.5 text-purple-400" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black text-white tracking-tight truncate", children: "Loja Oficial" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-extrabold uppercase px-1.5 py-0.2 rounded bg-purple-500/20 text-purple-300 border border-purple-500/30 shrink-0", children: "Rock Encantech" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-zinc-400 block truncate", children: [
            baseRate,
            " a ",
            clubRate,
            " nfs/R$ · +100 nfs 1ª compra"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2.5 py-1 rounded-full bg-zinc-950 border border-zinc-800 flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-2 rounded-full bg-lime-400 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-mono font-black text-lime-400", children: [
            balance.toLocaleString("pt-BR"),
            " nfs"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] text-zinc-400 font-medium hidden sm:inline", children: [
            "(R$ ",
            cashEquivalent,
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: handleRefresh, title: "Recarregar catálogo", className: "size-7 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 grid place-items-center transition active:scale-95 border border-zinc-700", "aria-label": "Recarregar catálogo", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: `size-3.5 ${isLoading ? "animate-spin text-purple-400" : ""}` }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: handleOpenExternal, title: "Abrir em tela cheia externa", className: "size-7 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 grid place-items-center transition active:scale-95 border border-zinc-700", "aria-label": "Abrir em nova aba", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "size-3.5" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 w-full h-[calc(100dvh-125px)] bg-zinc-950 overflow-hidden", children: [
      ...
      hasError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-zinc-950 z-20 flex flex-col items-center justify-center p-6 text-center space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400 max-w-xs", children: "Verifique sua conexão ou clique abaixo para acessar a loja diretamente." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleOpenExternal, className: "px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs flex items-center gap-2 shadow-lg shadow-purple-600/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Abrir Catálogo Completo" }),
