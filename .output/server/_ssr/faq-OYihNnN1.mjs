...
import { ak as Search, al as Scale, n as FileText, am as BookOpen, x as Download, j as ShieldCheck, an as CircleQuestionMark, ao as ChevronUp, C as ChevronDown, a2 as Mail } from "../_libs/lucide-react.mjs";
...
function FaqPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-white font-sans selection:bg-cyan-500 selection:text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 px-6 bg-gradient-to-b from-cyan-950/40 via-zinc-950 to-zinc-950 border-b border-zinc-800/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-extrabold uppercase tracking-widest text-cyan-400 bg-cyan-400/10 px-3 py-1 rounded-full border border-cyan-400/20", children: "Central de Ajuda & Termos Legais" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 border border-zinc-800 rounded-2xl p-5 space-y-4 flex flex-col justify-between hover:border-purple-500/40 transition", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/Netfits_Regulamento_e_Termo_LGPD_Oficial.docx", download: "Netfits_Regulamento_e_Termo_LGPD_Oficial.docx", className: "py-2.5 px-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center justify-center gap-1.5 transition cursor-pointer", title: "Baixar Minuta Oficial em Word (.docx)", children: [
    ...
    showRegulamentoModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl bg-zinc-900 border border-purple-500/40 rounded-3xl p-6 shadow-2xl space-y-4 max-h-[85vh] flex flex-col text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-4 text-xs text-zinc-300 leading-relaxed pr-2 border-b border-zinc-800 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-950/40 border border-purple-500/30 p-3 rounded-2xl text-[11px] text-purple-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white mb-0.5", children: "📌 Razão Social da Organizadora:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "NETFITS LTDA." }),
            " (CNPJ nº 00.000.000/0001-00) — Av. Brigadeiro Faria Lima, 3477, Itaim Bibi, São Paulo/SP."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Cláusula 1ª — Do Objeto e da Adesão" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "O Regulamento rege a participação no Programa Netfits, ecossistema digital de longevidade, treino e acúmulo de pontos nfs. A adesão se consolida ao cadastrar-se no app ou web." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Cláusula 4ª — Matriz Antifraude e Retenção de Vídeos (100% Dwell Time)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "A atribuição de pontos nfs por vídeos exige ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "retenção visual contínua de 100% do tempo de duração do arquivo" }),
          ". É proibido o uso de robôs, scripts, emuladores de GPS, automações ou contas falsas."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-950/60 border border-red-500/50 p-3 rounded-2xl text-[11px] text-red-200 space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-black text-red-400", children: "⚠️ Cláusula 5ª — DIREITO IRREVOGÁVEL DE EXCLUSÃO SUMÁRIA:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "A NETFITS LTDA. reserva-se o direito incondicional e inalienável de ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "cancelar ou excluir sumariamente qualquer conta de Usuário" }),
            " em caso de descumprimento do Regulamento ou suspeita de fraude, resultando na ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "perda imediata e irreversível de 100% dos pontos nfs acumulados" }),
            ", sem qualquer direito a reembolso ou indenização."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "Cláusula 6ª — Validade dos Pontos (Política FEFO)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Os pontos nfs expiram em 12 a 24 meses sob o algoritmo FEFO (First-Expiring, First-Out), priorizando o consumo dos lotes com vencimento mais próximo." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 pt-1 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/Netfits_Regulamento_e_Termo_LGPD_Oficial.docx", download: "Netfits_Regulamento_e_Termo_LGPD_Oficial.docx", className: "py-2.5 px-4 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-bold text-xs flex items-center gap-2 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-4 text-lime-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Baixar Minuta em Word (.docx)" })
        ] }),
    ...
    showLgpdModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl bg-zinc-900 border border-lime-500/40 rounded-3xl p-6 shadow-2xl space-y-4 max-h-[85vh] flex flex-col text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center pb-3 border-b border-zinc-800 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-4 text-xs text-zinc-300 leading-relaxed pr-2 border-b border-zinc-800 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-lime-950/40 border border-lime-500/30 p-3 rounded-2xl text-[11px] text-lime-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white mb-0.5", children: "🔒 Conformidade com a Lei Federal nº 13.709/2018:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "A ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "NETFITS LTDA." }),
            " atua como Controladora responsável pelo tratamento seguro dos dados pessoais e sensíveis do Titular."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "1. Categorias de Dados Coletados" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Tratamento de dados cadastrais (Nome, CPF, E-mail, Celular, Nascimento), dados de atividade física/saúde (passos, treinos, GPS via Apple Health/Google Fit/Garmin) e dados de navegação (dwell time em vídeos e IP)." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "2. Finalidades do Tratamento" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Atribuição de pontos nfs, auditoria da Matriz Antifraude, emissão de comprovantes contábeis e fiscais, e oferta personalizada de benefícios esportivos." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-extrabold text-white text-sm", children: "3. Direitos do Titular (Art. 18 da LGPD)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Confirmação, acesso, correção, anonimização, bloqueio ou eliminação de dados solicitados através do canal oficial do Encarregado de Dados pelo e-mail ",
