...
import { u as useOperationalParams } from "./operational-params-store-CtGNL8yQ.mjs";
import { a0 as Lock, a1 as LogIn, O as Percent, C as Check, f as Copy, e as Share2, U as Users, S as ShoppingBag, k as Coins, D as DollarSign, c as Sparkles, t as Download, E as Eye, a2 as Video, A as Activity, a as Award } from "../_libs/lucide-react.mjs";
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-center items-center px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-zinc-900 border border-purple-500/30 rounded-3xl p-8 shadow-2xl space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-400", children: "Digite suas credenciais de influenciador credenciado para acessar seu extrato de comissões." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLoginSubmit, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: loginCode, onChange: (e) => setLoginCode(e.target.value), placeholder: "GALLO-NETFITS", className: "w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-xs font-medium text-white focus:outline-none focus:ring-2 focus:ring-purple-600", required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950/80 p-3 rounded-2xl border border-zinc-800 text-[11px] text-zinc-400 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "🔑 Credenciais de Teste Associado:" }),
