...
import { u as useOperationalParams, o as operationalParamsStore } from "./operational-params-store-i_-wQLwy.mjs";
import { n as netfitsLogo } from "./router-D988PTjT.mjs";
import { j as ChartColumn, F as FileText, a as Award, k as Coins, l as SlidersVertical, R as Rss, S as ShoppingBag, A as Activity, U as Users, m as Handshake, n as Cpu, D as DollarSign, o as ShieldAlert, T as TrendingUp, p as RefreshCw, q as Layers, r as ChevronDown, s as Clock, t as Download, Z as Zap, u as Megaphone, v as MousePointerClick, E as Eye, w as Store, x as Tag, G as Gift, y as Truck, z as Star, I as ShoppingCart, J as Funnel, K as RotateCcw, c as Sparkles, N as Save, O as Percent, Q as UserCheck, V as ArrowUpRight, Y as ArrowDownRight, _ as ChevronLeft, $ as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen max-w-full overflow-x-hidden bg-zinc-950 text-zinc-100 font-sans pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "p-4 sm:p-6 max-w-7xl mx-auto w-full space-y-6 overflow-x-hidden", children: [
      ...
      activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-950/80 via-zinc-900 to-zinc-950 border border-purple-500/40 rounded-3xl p-5 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold uppercase tracking-widest text-lime-400 bg-lime-400/10 px-2.5 py-0.5 rounded-full border border-lime-400/20", children: "Novo Módulo Fiscal & Contábil" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-base font-extrabold text-white flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("xml"), className: "px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs flex items-center gap-1.5 transition shadow-lg shadow-purple-600/30", children: [
    ...
    showPitchDeckModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-purple-500/30 rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6 space-y-6 shadow-2xl flex flex-col justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-4", children: [
        ...
        pitchSlide === 7 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-white", children: "📈 DRE Proforma — Fase 1 (Launch) vs Fase 2 (Netfits Club R$ 19,90/mês)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 p-4 rounded-2xl border border-zinc-800 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime-400 font-bold", children: "FASE 1: LAUNCH INICIAL" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-400", children: [
                "Receita Bruta: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "R$ 893.850,00" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-400", children: [
                "EBITDA: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: "text-lime-400", children: "R$ 157.625,40 (17,6%)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-400", children: [
                "Lucro Líquido: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "R$ 129.895,34 (14,5%)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 p-4 rounded-2xl border border-purple-500/40 bg-purple-950/20 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-purple-300 font-bold", children: "FASE 2: EXPANSÃO COM CLUBE R$ 19,90/MÊS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-300", children: [
                "Receita Bruta: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "R$ 1.789.350,00" }),
                " (+100,2%)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-300", children: [
                "EBITDA: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: "text-lime-400", children: "R$ 963.080,40 (53,8% MARGEM)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-300", children: [
                "Lucro Líquido: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: "text-purple-300", children: "R$ 815.958,34 (45,6%)" })
              ] })
            ] })
          ] })
        ] }),
